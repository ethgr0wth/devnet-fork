(()=>{function yt(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var be=yt();function hs(d){be=d}var Ce={exec:()=>null};function I(d,e=""){let t=typeof d=="string"?d:d.source,s={replace:(a,i)=>{let n=typeof i=="string"?i:i.source;return n=n.replace(U.caret,"$1"),t=t.replace(a,n),s},getRegex:()=>new RegExp(t,e)};return s}var Ws=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),U={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:d=>new RegExp(`^( {0,3}${d})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:d=>new RegExp(`^ {0,${Math.min(3,d-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:d=>new RegExp(`^ {0,${Math.min(3,d-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:d=>new RegExp(`^ {0,${Math.min(3,d-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:d=>new RegExp(`^ {0,${Math.min(3,d-1)}}#`),htmlBeginRegex:d=>new RegExp(`^ {0,${Math.min(3,d-1)}}<(?:[a-z].*>|!--)`,"i")},Xs=/^(?:[ \t]*(?:\n|$))+/,Ys=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Vs=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,He=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Js=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,wt=/(?:[*+-]|\d{1,9}[.)])/,gs=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,fs=I(gs).replace(/bull/g,wt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Zs=I(gs).replace(/bull/g,wt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),kt=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Qs=/^[^\n]+/,Et=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Ks=I(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Et).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),ea=I(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,wt).getRegex(),Ke="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Tt=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ta=I("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Tt).replace("tag",Ke).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),bs=I(kt).replace("hr",He).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ke).getRegex(),sa=I(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",bs).getRegex(),St={blockquote:sa,code:Ys,def:Ks,fences:Vs,heading:Js,hr:He,html:ta,lheading:fs,list:ea,newline:Xs,paragraph:bs,table:Ce,text:Qs},ls=I("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",He).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ke).getRegex(),aa={...St,lheading:Zs,table:ls,paragraph:I(kt).replace("hr",He).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",ls).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ke).getRegex()},ia={...St,html:I(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Tt).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ce,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:I(kt).replace("hr",He).replace("heading",` *#{1,6} *[^
]`).replace("lheading",fs).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},na=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,oa=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,vs=/^( {2,}|\\)\n(?!\s*$)/,ra=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,et=/[\p{P}\p{S}]/u,Lt=/[\s\p{P}\p{S}]/u,xs=/[^\s\p{P}\p{S}]/u,la=I(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Lt).getRegex(),ys=/(?!~)[\p{P}\p{S}]/u,da=/(?!~)[\s\p{P}\p{S}]/u,ca=/(?:[^\s\p{P}\p{S}]|~)/u,pa=I(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Ws?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),ws=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,ma=I(ws,"u").replace(/punct/g,et).getRegex(),ua=I(ws,"u").replace(/punct/g,ys).getRegex(),ks="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",ha=I(ks,"gu").replace(/notPunctSpace/g,xs).replace(/punctSpace/g,Lt).replace(/punct/g,et).getRegex(),ga=I(ks,"gu").replace(/notPunctSpace/g,ca).replace(/punctSpace/g,da).replace(/punct/g,ys).getRegex(),fa=I("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,xs).replace(/punctSpace/g,Lt).replace(/punct/g,et).getRegex(),ba=I(/\\(punct)/,"gu").replace(/punct/g,et).getRegex(),va=I(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),xa=I(Tt).replace("(?:-->|$)","-->").getRegex(),ya=I("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",xa).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Je=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,wa=I(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Je).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Es=I(/^!?\[(label)\]\[(ref)\]/).replace("label",Je).replace("ref",Et).getRegex(),Ts=I(/^!?\[(ref)\](?:\[\])?/).replace("ref",Et).getRegex(),ka=I("reflink|nolink(?!\\()","g").replace("reflink",Es).replace("nolink",Ts).getRegex(),ds=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,$t={_backpedal:Ce,anyPunctuation:ba,autolink:va,blockSkip:pa,br:vs,code:oa,del:Ce,emStrongLDelim:ma,emStrongRDelimAst:ha,emStrongRDelimUnd:fa,escape:na,link:wa,nolink:Ts,punctuation:la,reflink:Es,reflinkSearch:ka,tag:ya,text:ra,url:Ce},Ea={...$t,link:I(/^!?\[(label)\]\((.*?)\)/).replace("label",Je).getRegex(),reflink:I(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Je).getRegex()},bt={...$t,emStrongRDelimAst:ga,emStrongLDelim:ua,url:I(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",ds).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:I(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",ds).getRegex()},Ta={...bt,br:I(vs).replace("{2,}","*").getRegex(),text:I(bt.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Ve={normal:St,gfm:aa,pedantic:ia},Ae={normal:$t,gfm:bt,breaks:Ta,pedantic:Ea},Sa={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},cs=d=>Sa[d];function pe(d,e){if(e){if(U.escapeTest.test(d))return d.replace(U.escapeReplace,cs)}else if(U.escapeTestNoEncode.test(d))return d.replace(U.escapeReplaceNoEncode,cs);return d}function ps(d){try{d=encodeURI(d).replace(U.percentDecode,"%")}catch{return null}return d}function ms(d,e){let t=d.replace(U.findPipe,(i,n,l)=>{let o=!1,r=n;for(;--r>=0&&l[r]==="\\";)o=!o;return o?"|":" |"}),s=t.split(U.splitPipe),a=0;if(s[0].trim()||s.shift(),s.length>0&&!s.at(-1)?.trim()&&s.pop(),e)if(s.length>e)s.splice(e);else for(;s.length<e;)s.push("");for(;a<s.length;a++)s[a]=s[a].trim().replace(U.slashPipe,"|");return s}function Ie(d,e,t){let s=d.length;if(s===0)return"";let a=0;for(;a<s;){let i=d.charAt(s-a-1);if(i===e&&!t)a++;else if(i!==e&&t)a++;else break}return d.slice(0,s-a)}function La(d,e){if(d.indexOf(e[1])===-1)return-1;let t=0;for(let s=0;s<d.length;s++)if(d[s]==="\\")s++;else if(d[s]===e[0])t++;else if(d[s]===e[1]&&(t--,t<0))return s;return t>0?-2:-1}function us(d,e,t,s,a){let i=e.href,n=e.title||null,l=d[1].replace(a.other.outputLinkReplace,"$1");s.state.inLink=!0;let o={type:d[0].charAt(0)==="!"?"image":"link",raw:t,href:i,title:n,text:l,tokens:s.inlineTokens(l)};return s.state.inLink=!1,o}function $a(d,e,t){let s=d.match(t.other.indentCodeCompensation);if(s===null)return e;let a=s[1];return e.split(`
`).map(i=>{let n=i.match(t.other.beginningSpace);if(n===null)return i;let[l]=n;return l.length>=a.length?i.slice(a.length):i}).join(`
`)}var Ze=class{options;rules;lexer;constructor(d){this.options=d||be}space(d){let e=this.rules.block.newline.exec(d);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(d){let e=this.rules.block.code.exec(d);if(e){let t=e[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?t:Ie(t,`
`)}}}fences(d){let e=this.rules.block.fences.exec(d);if(e){let t=e[0],s=$a(t,e[3]||"",this.rules);return{type:"code",raw:t,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:s}}}heading(d){let e=this.rules.block.heading.exec(d);if(e){let t=e[2].trim();if(this.rules.other.endingHash.test(t)){let s=Ie(t,"#");(this.options.pedantic||!s||this.rules.other.endingSpaceChar.test(s))&&(t=s.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:t,tokens:this.lexer.inline(t)}}}hr(d){let e=this.rules.block.hr.exec(d);if(e)return{type:"hr",raw:Ie(e[0],`
`)}}blockquote(d){let e=this.rules.block.blockquote.exec(d);if(e){let t=Ie(e[0],`
`).split(`
`),s="",a="",i=[];for(;t.length>0;){let n=!1,l=[],o;for(o=0;o<t.length;o++)if(this.rules.other.blockquoteStart.test(t[o]))l.push(t[o]),n=!0;else if(!n)l.push(t[o]);else break;t=t.slice(o);let r=l.join(`
`),p=r.replace(this.rules.other.blockquoteSetextReplace,`
    $1`).replace(this.rules.other.blockquoteSetextReplace2,"");s=s?`${s}
${r}`:r,a=a?`${a}
${p}`:p;let m=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(p,i,!0),this.lexer.state.top=m,t.length===0)break;let f=i.at(-1);if(f?.type==="code")break;if(f?.type==="blockquote"){let b=f,u=b.raw+`
`+t.join(`
`),h=this.blockquote(u);i[i.length-1]=h,s=s.substring(0,s.length-b.raw.length)+h.raw,a=a.substring(0,a.length-b.text.length)+h.text;break}else if(f?.type==="list"){let b=f,u=b.raw+`
`+t.join(`
`),h=this.list(u);i[i.length-1]=h,s=s.substring(0,s.length-f.raw.length)+h.raw,a=a.substring(0,a.length-b.raw.length)+h.raw,t=u.substring(i.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:s,tokens:i,text:a}}}list(d){let e=this.rules.block.list.exec(d);if(e){let t=e[1].trim(),s=t.length>1,a={type:"list",raw:"",ordered:s,start:s?+t.slice(0,-1):"",loose:!1,items:[]};t=s?`\\d{1,9}\\${t.slice(-1)}`:`\\${t}`,this.options.pedantic&&(t=s?t:"[*+-]");let i=this.rules.other.listItemRegex(t),n=!1;for(;d;){let o=!1,r="",p="";if(!(e=i.exec(d))||this.rules.block.hr.test(d))break;r=e[0],d=d.substring(r.length);let m=e[2].split(`
`,1)[0].replace(this.rules.other.listReplaceTabs,h=>" ".repeat(3*h.length)),f=d.split(`
`,1)[0],b=!m.trim(),u=0;if(this.options.pedantic?(u=2,p=m.trimStart()):b?u=e[1].length+1:(u=e[2].search(this.rules.other.nonSpaceChar),u=u>4?1:u,p=m.slice(u),u+=e[1].length),b&&this.rules.other.blankLine.test(f)&&(r+=f+`
...
`,1)[0],L;if(f=S,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),L=f):L=f.replace(this.rules.other.tabCharGlobal,"    "),y.test(f)||w.test(f)||k.test(f)||h.test(f)||v.test(f))break;if(L.search(this.rules.other.nonSpaceChar)>=u||!f.trim())p+=`
`+L.slice(u);else{if(b||m.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||y.test(m)||w.test(m)||v.test(m))break;p+=`
`+f}!b&&!f.trim()&&(b=!0),r+=S+`
`,d=d.substring(S.length+1),m=L.slice(u)}}a.loose||(n?a.loose=!0:this.rules.other.doubleBlankLine.test(r)&&(n=!0)),a.items.push({type:"list_item",raw:r,task:!!this.options.gfm&&this.rules.other.listIsTask.test(p),loose:!1,text:p,tokens:[]}),a.raw+=r}let l=a.items.at(-1);if(l)l.raw=l.raw.trimEnd(),l.text=l.text.trimEnd();else return;a.raw=a.raw.trimEnd();for(let o of a.items){if(this.lexer.state.top=!1,o.tokens=this.lexer.blockTokens(o.text,[]),o.task){if(o.text=o.text.replace(this.rules.other.listReplaceTask,""),o.tokens[0]?.type==="text"||o.tokens[0]?.type==="paragraph"){o.tokens[0].raw=o.tokens[0].raw.replace(this.rules.other.listReplaceTask,""),o.tokens[0].text=o.tokens[0].text.replace(this.rules.other.listReplaceTask,"");for(let p=this.lexer.inlineQueue.length-1;p>=0;p--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[p].src)){this.lexer.inlineQueue[p].src=this.lexer.inlineQueue[p].src.replace(this.rules.other.listReplaceTask,"");break}}let r=this.rules.other.listTaskCheckbox.exec(o.raw);if(r){let p={type:"checkbox",raw:r[0]+" ",checked:r[0]!=="[ ]"};o.checked=p.checked,a.loose?o.tokens[0]&&["paragraph","text"].includes(o.tokens[0].type)&&"tokens"in o.tokens[0]&&o.tokens[0].tokens?(o.tokens[0].raw=p.raw+o.tokens[0].raw,o.tokens[0].text=p.raw+o.tokens[0].text,o.tokens[0].tokens.unshift(p)):o.tokens.unshift({type:"paragraph",raw:p.raw,text:p.raw,tokens:[p]}):o.tokens.unshift(p)}}if(!a.loose){let r=o.tokens.filter(m=>m.type==="space"),p=r.length>0&&r.some(m=>this.rules.other.anyLine.test(m.raw));a.loose=p}}if(a.loose)for(let o of a.items){o.loose=!0;for(let r of o.tokens)r.type==="text"&&(r.type="paragraph")}return a}}html(d){let e=this.rules.block.html.exec(d);if(e)return{type:"html",block:!0,raw:e[0],pre:e[1]==="pre"||e[1]==="script"||e[1]==="style",text:e[0]}}def(d){let e=this.rules.block.def.exec(d);if(e){let t=e[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),s=e[2]?e[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",a=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):e[3];return{type:"def",tag:t,raw:e[0],href:s,title:a}}}table(d){let e=this.rules.block.table.exec(d);if(!e||!this.rules.other.tableDelimiter.test(e[2]))return;let t=ms(e[1]),s=e[2].replace(this.rules.other.tableAlignChars,"").split("|"),a=e[3]?.trim()?e[3].replace(this.rules.other.tableRowBlankLine,"").split(`
`):[],i={type:"table",raw:e[0],header:[],align:[],rows:[]};if(t.length===s.length){for(let n of s)this.rules.other.tableAlignRight.test(n)?i.align.push("right"):this.rules.other.tableAlignCenter.test(n)?i.align.push("center"):this.rules.other.tableAlignLeft.test(n)?i.align.push("left"):i.align.push(null);for(let n=0;n<t.length;n++)i.header.push({text:t[n],tokens:this.lexer.inline(t[n]),header:!0,align:i.align[n]});for(let n of a)i.rows.push(ms(n,i.header.length).map((l,o)=>({text:l,tokens:this.lexer.inline(l),header:!1,align:i.align[o]})));return i}}lheading(d){let e=this.rules.block.lheading.exec(d);if(e)return{type:"heading",raw:e[0],depth:e[2].charAt(0)==="="?1:2,text:e[1],tokens:this.lexer.inline(e[1])}}paragraph(d){let e=this.rules.block.paragraph.exec(d);if(e){let t=e[1].charAt(e[1].length-1)===`
`?e[1].slice(0,-1):e[1];return{type:"paragraph",raw:e[0],text:t,tokens:this.lexer.inline(t)}}}text(d){let e=this.rules.block.text.exec(d);if(e)return{type:"text",raw:e[0],text:e[0],tokens:this.lexer.inline(e[0])}}escape(d){let e=this.rules.inline.escape.exec(d);if(e)return{type:"escape",raw:e[0],text:e[1]}}tag(d){let e=this.rules.inline.tag.exec(d);if(e)return!this.lexer.state.inLink&&this.rules.other.startATag.test(e[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(e[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(e[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(e[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:e[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:e[0]}}link(d){let e=this.rules.inline.link.exec(d);if(e){let t=e[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(t)){if(!this.rules.other.endAngleBracket.test(t))return;let i=Ie(t.slice(0,-1),"\\");if((t.length-i.length)%2===0)return}else{let i=La(e[2],"()");if(i===-2)return;if(i>-1){let n=(e[0].indexOf("!")===0?5:4)+e[1].length+i;e[2]=e[2].substring(0,i),e[0]=e[0].substring(0,n).trim(),e[3]=""}}let s=e[2],a="";if(this.options.pedantic){let i=this.rules.other.pedanticHrefTitle.exec(s);i&&(s=i[1],a=i[3])}else a=e[3]?e[3].slice(1,-1):"";return s=s.trim(),this.rules.other.startAngleBracket.test(s)&&(this.options.pedantic&&!this.rules.other.endAngleBracket.test(t)?s=s.slice(1):s=s.slice(1,-1)),us(e,{href:s&&s.replace(this.rules.inline.anyPunctuation,"$1"),title:a&&a.replace(this.rules.inline.anyPunctuation,"$1")},e[0],this.lexer,this.rules)}}reflink(d,e){let t;if((t=this.rules.inline.reflink.exec(d))||(t=this.rules.inline.nolink.exec(d))){let s=(t[2]||t[1]).replace(this.rules.other.multipleSpaceGlobal," "),a=e[s.toLowerCase()];if(!a){let i=t[0].charAt(0);return{type:"text",raw:i,text:i}}return us(t,a,t[0],this.lexer,this.rules)}}emStrong(d,e,t=""){let s=this.rules.inline.emStrongLDelim.exec(d);if(!(!s||s[3]&&t.match(this.rules.other.unicodeAlphaNumeric))&&(!(s[1]||s[2])||!t||this.rules.inline.punctuation.exec(t))){let a=[...s[0]].length-1,i,n,l=a,o=0,r=s[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(r.lastIndex=0,e=e.slice(-1*d.length+a);(s=r.exec(e))!=null;){if(i=s[1]||s[2]||s[3]||s[4]||s[5]||s[6],!i)continue;if(n=[...i].length,s[3]||s[4]){l+=n;continue}else if((s[5]||s[6])&&a%3&&!((a+n)%3)){o+=n;continue}if(l-=n,l>0)continue;n=Math.min(n,n+l+o);let p=[...s[0]][0].length,m=d.slice(0,a+s.index+p+n);if(Math.min(a,n)%2){let b=m.slice(1,-1);return{type:"em",raw:m,text:b,tokens:this.lexer.inlineTokens(b)}}let f=m.slice(2,-2);return{type:"strong",raw:m,text:f,tokens:this.lexer.inlineTokens(f)}}}}codespan(d){let e=this.rules.inline.code.exec(d);if(e){let t=e[2].replace(this.rules.other.newLineCharGlobal," "),s=this.rules.other.nonSpaceChar.test(t),a=this.rules.other.startingSpaceChar.test(t)&&this.rules.other.endingSpaceChar.test(t);return s&&a&&(t=t.substring(1,t.length-1)),{type:"codespan",raw:e[0],text:t}}}br(d){let e=this.rules.inline.br.exec(d);if(e)return{type:"br",raw:e[0]}}del(d){let e=this.rules.inline.del.exec(d);if(e)return{type:"del",raw:e[0],text:e[2],tokens:this.lexer.inlineTokens(e[2])}}autolink(d){let e=this.rules.inline.autolink.exec(d);if(e){let t,s;return e[2]==="@"?(t=e[1],s="mailto:"+t):(t=e[1],s=t),{type:"link",raw:e[0],text:t,href:s,tokens:[{type:"text",raw:t,text:t}]}}}url(d){let e;if(e=this.rules.inline.url.exec(d)){let t,s;if(e[2]==="@")t=e[0],s="mailto:"+t;else{let a;do a=e[0],e[0]=this.rules.inline._backpedal.exec(e[0])?.[0]??"";while(a!==e[0]);t=e[0],e[1]==="www."?s="http://"+e[0]:s=e[0]}return{type:"link",raw:e[0],text:t,href:s,tokens:[{type:"text",raw:t,text:t}]}}}inlineText(d){let e=this.rules.inline.text.exec(d);if(e){let t=this.lexer.state.inRawBlock;return{type:"text",raw:e[0],text:e[0],escaped:t}}}},K=class vt{tokens;options;state;inlineQueue;tokenizer;constructor(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||be,this.options.tokenizer=this.options.tokenizer||new Ze,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={other:U,block:Ve.normal,inline:Ae.normal};this.options.pedantic?(t.block=Ve.pedantic,t.inline=Ae.pedantic):this.options.gfm&&(t.block=Ve.gfm,this.options.breaks?t.inline=Ae.breaks:t.inline=Ae.gfm),this.tokenizer.rules=t}static get rules(){return{block:Ve,inline:Ae}}static lex(e,t){return new vt(t).lex(e)}static lexInline(e,t){return new vt(t).inlineTokens(e)}lex(e){e=e.replace(U.carriageReturn,`
`),this.blockTokens(e,this.tokens);for(let t=0;t<this.inlineQueue.length;t++){let s=this.inlineQueue[t];this.inlineTokens(s.src,s.tokens)}return this.inlineQueue=[],this.tokens}blockTokens(e,t=[],s=!1){for(this.options.pedantic&&(e=e.replace(U.tabCharGlobal,"    ").replace(U.spaceLine,""));e;){let a;if(this.options.extensions?.block?.some(n=>(a=n.call({lexer:this},e,t))?(e=e.substring(a.raw.length),t.push(a),!0):!1))continue;if(a=this.tokenizer.space(e)){e=e.substring(a.raw.length);let n=t.at(-1);a.raw.length===1&&n!==void 0?n.raw+=`
`:t.push(a);continue}if(a=this.tokenizer.code(e)){e=e.substring(a.raw.length);let n=t.at(-1);n?.type==="paragraph"||n?.type==="text"?(n.raw+=(n.raw.endsWith(`
`)?"":`
`)+a.raw,n.text+=`
...
`)?"":`
`)+a.raw,n.text+=`
`+a.raw,this.inlineQueue.at(-1).src=n.text):this.tokens.links[a.tag]||(this.tokens.links[a.tag]={href:a.href,title:a.title},t.push(a));continue}if(a=this.tokenizer.table(e)){e=e.substring(a.raw.length),t.push(a);continue}if(a=this.tokenizer.lheading(e)){e=e.substring(a.raw.length),t.push(a);continue}let i=e;if(this.options.extensions?.startBlock){let n=1/0,l=e.slice(1),o;this.options.extensions.startBlock.forEach(r=>{o=r.call({lexer:this},l),typeof o=="number"&&o>=0&&(n=Math.min(n,o))}),n<1/0&&n>=0&&(i=e.substring(0,n+1))}if(this.state.top&&(a=this.tokenizer.paragraph(i))){let n=t.at(-1);s&&n?.type==="paragraph"?(n.raw+=(n.raw.endsWith(`
`)?"":`
`)+a.raw,n.text+=`
`+a.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=n.text):t.push(a),s=i.length!==e.length,e=e.substring(a.raw.length);continue}if(a=this.tokenizer.text(e)){e=e.substring(a.raw.length);let n=t.at(-1);n?.type==="text"?(n.raw+=(n.raw.endsWith(`
`)?"":`
`)+a.raw,n.text+=`
`+a.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=n.text):t.push(a);continue}if(e){let n="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(n);break}else throw new Error(n)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){let s=e,a=null;if(this.tokens.links){let o=Object.keys(this.tokens.links);if(o.length>0)for(;(a=this.tokenizer.rules.inline.reflinkSearch.exec(s))!=null;)o.includes(a[0].slice(a[0].lastIndexOf("[")+1,-1))&&(s=s.slice(0,a.index)+"["+"a".repeat(a[0].length-2)+"]"+s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(a=this.tokenizer.rules.inline.anyPunctuation.exec(s))!=null;)s=s.slice(0,a.index)+"++"+s.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let i;for(;(a=this.tokenizer.rules.inline.blockSkip.exec(s))!=null;)i=a[2]?a[2].length:0,s=s.slice(0,a.index+i)+"["+"a".repeat(a[0].length-i-2)+"]"+s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);s=this.options.hooks?.emStrongMask?.call({lexer:this},s)??s;let n=!1,l="";for(;e;){n||(l=""),n=!1;let o;if(this.options.extensions?.inline?.some(p=>(o=p.call({lexer:this},e,t))?(e=e.substring(o.raw.length),t.push(o),!0):!1))continue;if(o=this.tokenizer.escape(e)){e=e.substring(o.raw.length),t.push(o);continue}if(o=this.tokenizer.tag(e)){e=e.substring(o.raw.length),t.push(o);continue}if(o=this.tokenizer.link(e)){e=e.substring(o.raw.length),t.push(o);continue}if(o=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(o.raw.length);let p=t.at(-1);o.type==="text"&&p?.type==="text"?(p.raw+=o.raw,p.text+=o.text):t.push(o);continue}if(o=this.tokenizer.emStrong(e,s,l)){e=e.substring(o.raw.length),t.push(o);continue}if(o=this.tokenizer.codespan(e)){e=e.substring(o.raw.length),t.push(o);continue}if(o=this.tokenizer.br(e)){e=e.substring(o.raw.length),t.push(o);continue}if(o=this.tokenizer.del(e)){e=e.substring(o.raw.length),t.push(o);continue}if(o=this.tokenizer.autolink(e)){e=e.substring(o.raw.length),t.push(o);continue}if(!this.state.inLink&&(o=this.tokenizer.url(e))){e=e.substring(o.raw.length),t.push(o);continue}let r=e;if(this.options.extensions?.startInline){let p=1/0,m=e.slice(1),f;this.options.extensions.startInline.forEach(b=>{f=b.call({lexer:this},m),typeof f=="number"&&f>=0&&(p=Math.min(p,f))}),p<1/0&&p>=0&&(r=e.substring(0,p+1))}if(o=this.tokenizer.inlineText(r)){e=e.substring(o.raw.length),o.raw.slice(-1)!=="_"&&(l=o.raw.slice(-1)),n=!0;let p=t.at(-1);p?.type==="text"?(p.raw+=o.raw,p.text+=o.text):t.push(o);continue}if(e){let p="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(p);break}else throw new Error(p)}}return t}},Qe=class{options;parser;constructor(d){this.options=d||be}space(d){return""}code({text:d,lang:e,escaped:t}){let s=(e||"").match(U.notSpaceStart)?.[0],a=d.replace(U.endingNewline,"")+`
`;return s?'<pre><code class="language-'+pe(s)+'">'+(t?a:pe(a,!0))+`</code></pre>
`:"<pre><code>"+(t?a:pe(a,!0))+`</code></pre>
...
`}hr(d){return`<hr>
`}list(d){let e=d.ordered,t=d.start,s="";for(let n=0;n<d.items.length;n++){let l=d.items[n];s+=this.listitem(l)}let a=e?"ol":"ul",i=e&&t!==1?' start="'+t+'"':"";return"<"+a+i+`>
`+s+"</"+a+`>
...
`}table(d){let e="",t="";for(let a=0;a<d.header.length;a++)t+=this.tablecell(d.header[a]);e+=this.tablerow({text:t});let s="";for(let a=0;a<d.rows.length;a++){let i=d.rows[a];t="";for(let n=0;n<i.length;n++)t+=this.tablecell(i[n]);s+=this.tablerow({text:t})}return s&&(s=`<tbody>${s}</tbody>`),`<table>
<thead>
`+e+`</thead>
`+s+`</table>
...
`}strong({tokens:d}){return`<strong>${this.parser.parseInline(d)}</strong>`}em({tokens:d}){return`<em>${this.parser.parseInline(d)}</em>`}codespan({text:d}){return`<code>${pe(d,!0)}</code>`}br(d){return"<br>"}del({tokens:d}){return`<del>${this.parser.parseInline(d)}</del>`}link({href:d,title:e,tokens:t}){let s=this.parser.parseInline(t),a=ps(d);if(a===null)return s;d=a;let i='<a href="'+d+'"';return e&&(i+=' title="'+pe(e)+'"'),i+=">"+s+"</a>",i}image({href:d,title:e,text:t,tokens:s}){s&&(t=this.parser.parseInline(s,this.parser.textRenderer));let a=ps(d);if(a===null)return pe(t);d=a;let i=`<img src="${d}" alt="${t}"`;return e&&(i+=` title="${pe(e)}"`),i+=">",i}text(d){return"tokens"in d&&d.tokens?this.parser.parseInline(d.tokens):"escaped"in d&&d.escaped?d.text:pe(d.text)}},Mt=class{strong({text:d}){return d}em({text:d}){return d}codespan({text:d}){return d}del({text:d}){return d}html({text:d}){return d}text({text:d}){return d}link({text:d}){return""+d}image({text:d}){return""+d}br(){return""}checkbox({raw:d}){return d}},ee=class xt{options;renderer;textRenderer;constructor(e){this.options=e||be,this.options.renderer=this.options.renderer||new Qe,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new Mt}static parse(e,t){return new xt(t).parse(e)}static parseInline(e,t){return new xt(t).parseInline(e)}parse(e){let t="";for(let s=0;s<e.length;s++){let a=e[s];if(this.options.extensions?.renderers?.[a.type]){let n=a,l=this.options.extensions.renderers[n.type].call({parser:this},n);if(l!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(n.type)){t+=l||"";continue}}let i=a;switch(i.type){case"space":{t+=this.renderer.space(i);break}case"hr":{t+=this.renderer.hr(i);break}case"heading":{t+=this.renderer.heading(i);break}case"code":{t+=this.renderer.code(i);break}case"table":{t+=this.renderer.table(i);break}case"blockquote":{t+=this.renderer.blockquote(i);break}case"list":{t+=this.renderer.list(i);break}case"checkbox":{t+=this.renderer.checkbox(i);break}case"html":{t+=this.renderer.html(i);break}case"def":{t+=this.renderer.def(i);break}case"paragraph":{t+=this.renderer.paragraph(i);break}case"text":{t+=this.renderer.text(i);break}default:{let n='Token with "'+i.type+'" type was not found.';if(this.options.silent)return console.error(n),"";throw new Error(n)}}}return t}parseInline(e,t=this.renderer){let s="";for(let a=0;a<e.length;a++){let i=e[a];if(this.options.extensions?.renderers?.[i.type]){let l=this.options.extensions.renderers[i.type].call({parser:this},i);if(l!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(i.type)){s+=l||"";continue}}let n=i;switch(n.type){case"escape":{s+=t.text(n);break}case"html":{s+=t.html(n);break}case"link":{s+=t.link(n);break}case"image":{s+=t.image(n);break}case"checkbox":{s+=t.checkbox(n);break}case"strong":{s+=t.strong(n);break}case"em":{s+=t.em(n);break}case"codespan":{s+=t.codespan(n);break}case"br":{s+=t.br(n);break}case"del":{s+=t.del(n);break}case"text":{s+=t.text(n);break}default:{let l='Token with "'+n.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return s}},_e=class{options;block;constructor(d){this.options=d||be}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(d){return d}postprocess(d){return d}processAllTokens(d){return d}emStrongMask(d){return d}provideLexer(){return this.block?K.lex:K.lexInline}provideParser(){return this.block?ee.parse:ee.parseInline}},Ma=class{defaults=yt();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=ee;Renderer=Qe;TextRenderer=Mt;Lexer=K;Tokenizer=Ze;Hooks=_e;constructor(...d){this.use(...d)}walkTokens(d,e){let t=[];for(let s of d)switch(t=t.concat(e.call(this,s)),s.type){case"table":{let a=s;for(let i of a.header)t=t.concat(this.walkTokens(i.tokens,e));for(let i of a.rows)for(let n of i)t=t.concat(this.walkTokens(n.tokens,e));break}case"list":{let a=s;t=t.concat(this.walkTokens(a.items,e));break}default:{let a=s;this.defaults.extensions?.childTokens?.[a.type]?this.defaults.extensions.childTokens[a.type].forEach(i=>{let n=a[i].flat(1/0);t=t.concat(this.walkTokens(n,e))}):a.tokens&&(t=t.concat(this.walkTokens(a.tokens,e)))}}return t}use(...d){let e=this.defaults.extensions||{renderers:{},childTokens:{}};return d.forEach(t=>{let s={...t};if(s.async=this.defaults.async||s.async||!1,t.extensions&&(t.extensions.forEach(a=>{if(!a.name)throw new Error("extension name required");if("renderer"in a){let i=e.renderers[a.name];i?e.renderers[a.name]=function(...n){let l=a.renderer.apply(this,n);return l===!1&&(l=i.apply(this,n)),l}:e.renderers[a.name]=a.renderer}if("tokenizer"in a){if(!a.level||a.level!=="block"&&a.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let i=e[a.level];i?i.unshift(a.tokenizer):e[a.level]=[a.tokenizer],a.start&&(a.level==="block"?e.startBlock?e.startBlock.push(a.start):e.startBlock=[a.start]:a.level==="inline"&&(e.startInline?e.startInline.push(a.start):e.startInline=[a.start]))}"childTokens"in a&&a.childTokens&&(e.childTokens[a.name]=a.childTokens)}),s.extensions=e),t.renderer){let a=this.defaults.renderer||new Qe(this.defaults);for(let i in t.renderer){if(!(i in a))throw new Error(`renderer '${i}' does not exist`);if(["options","parser"].includes(i))continue;let n=i,l=t.renderer[n],o=a[n];a[n]=(...r)=>{let p=l.apply(a,r);return p===!1&&(p=o.apply(a,r)),p||""}}s.renderer=a}if(t.tokenizer){let a=this.defaults.tokenizer||new Ze(this.defaults);for(let i in t.tokenizer){if(!(i in a))throw new Error(`tokenizer '${i}' does not exist`);if(["options","rules","lexer"].includes(i))continue;let n=i,l=t.tokenizer[n],o=a[n];a[n]=(...r)=>{let p=l.apply(a,r);return p===!1&&(p=o.apply(a,r)),p}}s.tokenizer=a}if(t.hooks){let a=this.defaults.hooks||new _e;for(let i in t.hooks){if(!(i in a))throw new Error(`hook '${i}' does not exist`);if(["options","block"].includes(i))continue;let n=i,l=t.hooks[n],o=a[n];_e.passThroughHooks.has(i)?a[n]=r=>{if(this.defaults.async&&_e.passThroughHooksRespectAsync.has(i))return(async()=>{let m=await l.call(a,r);return o.call(a,m)})();let p=l.call(a,r);return o.call(a,p)}:a[n]=(...r)=>{if(this.defaults.async)return(async()=>{let m=await l.apply(a,r);return m===!1&&(m=await o.apply(a,r)),m})();let p=l.apply(a,r);return p===!1&&(p=o.apply(a,r)),p}}s.hooks=a}if(t.walkTokens){let a=this.defaults.walkTokens,i=t.walkTokens;s.walkTokens=function(n){let l=[];return l.push(i.call(this,n)),a&&(l=l.concat(a.call(this,n))),l}}this.defaults={...this.defaults,...s}}),this}setOptions(d){return this.defaults={...this.defaults,...d},this}lexer(d,e){return K.lex(d,e??this.defaults)}parser(d,e){return ee.parse(d,e??this.defaults)}parseMarkdown(d){return(e,t)=>{let s={...t},a={...this.defaults,...s},i=this.onError(!!a.silent,!!a.async);if(this.defaults.async===!0&&s.async===!1)return i(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof e>"u"||e===null)return i(new Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return i(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if(a.hooks&&(a.hooks.options=a,a.hooks.block=d),a.async)return(async()=>{let n=a.hooks?await a.hooks.preprocess(e):e,l=await(a.hooks?await a.hooks.provideLexer():d?K.lex:K.lexInline)(n,a),o=a.hooks?await a.hooks.processAllTokens(l):l;a.walkTokens&&await Promise.all(this.walkTokens(o,a.walkTokens));let r=await(a.hooks?await a.hooks.provideParser():d?ee.parse:ee.parseInline)(o,a);return a.hooks?await a.hooks.postprocess(r):r})().catch(i);try{a.hooks&&(e=a.hooks.preprocess(e));let n=(a.hooks?a.hooks.provideLexer():d?K.lex:K.lexInline)(e,a);a.hooks&&(n=a.hooks.processAllTokens(n)),a.walkTokens&&this.walkTokens(n,a.walkTokens);let l=(a.hooks?a.hooks.provideParser():d?ee.parse:ee.parseInline)(n,a);return a.hooks&&(l=a.hooks.postprocess(l)),l}catch(n){return i(n)}}}onError(d,e){return t=>{if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,d){let s="<p>An error occurred:</p><pre>"+pe(t.message+"",!0)+"</pre>";return e?Promise.resolve(s):s}if(e)return Promise.reject(t);throw t}}},fe=new Ma;function _(d,e){return fe.parse(d,e)}_.options=_.setOptions=function(d){return fe.setOptions(d),_.defaults=fe.defaults,hs(_.defaults),_};_.getDefaults=yt;_.defaults=be;_.use=function(...d){return fe.use(...d),_.defaults=fe.defaults,hs(_.defaults),_};_.walkTokens=function(d,e){return fe.walkTokens(d,e)};_.parseInline=fe.parseInline;_.Parser=ee;_.parser=ee.parse;_.Renderer=Qe;_.TextRenderer=Mt;_.Lexer=K;_.lexer=K.lex;_.Tokenizer=Ze;_.Hooks=_e;_.parse=_;var Za=_.options,Qa=_.setOptions,Ka=_.use,ei=_.walkTokens,ti=_.parseInline;var si=ee.parse,ai=K.lex;var{entries:Cs,setPrototypeOf:Ss,isFrozen:za,getPrototypeOf:Aa,getOwnPropertyDescriptor:Ia}=Object,{freeze:W,seal:Q,create:jt}=Object,{apply:Bt,construct:Dt}=typeof Reflect<"u"&&Reflect;W||(W=function(e){return e});Q||(Q=function(e){return e});Bt||(Bt=function(e,t){for(var s=arguments.length,a=new Array(s>2?s-2:0),i=2;i<s;i++)a[i-2]=arguments[i];return e.apply(t,a)});Dt||(Dt=function(e){for(var t=arguments.length,s=new Array(t>1?t-1:0),a=1;a<t;a++)s[a-1]=arguments[a];return new e(...s)});var tt=X(Array.prototype.forEach),_a=X(Array.prototype.lastIndexOf),Ls=X(Array.prototype.pop),je=X(Array.prototype.push),Ca=X(Array.prototype.splice),at=X(String.prototype.toLowerCase),zt=X(String.prototype.toString),At=X(String.prototype.match),Be=X(String.prototype.replace),Ha=X(String.prototype.indexOf),ja=X(String.prototype.trim),te=X(Object.prototype.hasOwnProperty),q=X(RegExp.prototype.test),De=Ba(TypeError);function X(d){return function(e){e instanceof RegExp&&(e.lastIndex=0);for(var t=arguments.length,s=new Array(t>1?t-1:0),a=1;a<t;a++)s[a-1]=arguments[a];return Bt(d,e,s)}}function Ba(d){return function(){for(var e=arguments.length,t=new Array(e),s=0;s<e;s++)t[s]=arguments[s];return Dt(d,t)}}function A(d,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:at;Ss&&Ss(d,null);let s=e.length;for(;s--;){let a=e[s];if(typeof a=="string"){let i=t(a);i!==a&&(za(e)||(e[s]=i),a=i)}d[a]=!0}return d}function Da(d){for(let e=0;e<d.length;e++)te(d,e)||(d[e]=null);return d}function ne(d){let e=jt(null);for(let[t,s]of Cs(d))te(d,t)&&(Array.isArray(s)?e[t]=Da(s):s&&typeof s=="object"&&s.constructor===Object?e[t]=ne(s):e[t]=s);return e}function Pe(d,e){for(;d!==null;){let s=Ia(d,e);if(s){if(s.get)return X(s.get);if(typeof s.value=="function")return X(s.value)}d=Aa(d)}function t(){return null}return t}var $s=W(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),It=W(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),_t=W(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Pa=W(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ct=W(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),Ra=W(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Ms=W(["#text"]),zs=W(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),Ht=W(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),As=W(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),st=W(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Na=Q(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Oa=Q(/<%[\w\W]*|[\w\W]*%>/gm),Fa=Q(/\$\{[\w\W]*/gm),Ga=Q(/^data-[\-\w.\u00B7-\uFFFF]+$/),Ua=Q(/^aria-[\-\w]+$/),Hs=Q(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),qa=Q(/^(?:\w+script|data):/i),Wa=Q(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),js=Q(/^html$/i),Xa=Q(/^[a-z][.\w]*(-[.\w]+)+$/i),Is=Object.freeze({__proto__:null,ARIA_ATTR:Ua,ATTR_WHITESPACE:Wa,CUSTOM_ELEMENT:Xa,DATA_ATTR:Ga,DOCTYPE_NAME:js,ERB_EXPR:Oa,IS_ALLOWED_URI:Hs,IS_SCRIPT_OR_DATA:qa,MUSTACHE_EXPR:Na,TMPLIT_EXPR:Fa}),Re={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},Ya=function(){return typeof window>"u"?null:window},Va=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let s=null,a="data-tt-policy-suffix";t&&t.hasAttribute(a)&&(s=t.getAttribute(a));let i="dompurify"+(s?"#"+s:"");try{return e.createPolicy(i,{createHTML(n){return n},createScriptURL(n){return n}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},_s=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Bs(){let d=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Ya(),e=M=>Bs(M);if(e.version="3.3.1",e.removed=[],!d||!d.document||d.document.nodeType!==Re.document||!d.Element)return e.isSupported=!1,e;let{document:t}=d,s=t,a=s.currentScript,{DocumentFragment:i,HTMLTemplateElement:n,Node:l,Element:o,NodeFilter:r,NamedNodeMap:p=d.NamedNodeMap||d.MozNamedAttrMap,HTMLFormElement:m,DOMParser:f,trustedTypes:b}=d,u=o.prototype,h=Pe(u,"cloneNode"),v=Pe(u,"remove"),y=Pe(u,"nextSibling"),w=Pe(u,"childNodes"),k=Pe(u,"parentNode");if(typeof n=="function"){let M=t.createElement("template");M.content&&M.content.ownerDocument&&(t=M.content.ownerDocument)}let S,L="",{implementation:se,createNodeIterator:oe,createDocumentFragment:Y,getElementsByTagName:re}=t,{importNode:J}=s,z=_s();e.isSupported=typeof Cs=="function"&&typeof k=="function"&&se&&se.createHTMLDocument!==void 0;let{MUSTACHE_EXPR:g,ERB_EXPR:T,TMPLIT_EXPR:$,DATA_ATTR:F,ARIA_ATTR:Z,IS_SCRIPT_OR_DATA:ue,ATTR_WHITESPACE:Le,CUSTOM_ELEMENT:Oe}=Is,{IS_ALLOWED_URI:Rt}=Is,R=null,Nt=A({},[...$s,...It,..._t,...Ct,...Ms]),N=null,Ot=A({},[...zs,...Ht,...As,...st]),j=Object.seal(jt(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),$e=null,nt=null,xe=Object.seal(jt(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),Ft=!0,ot=!0,Gt=!1,Ut=!0,ye=!1,Fe=!0,he=!1,rt=!1,lt=!1,we=!1,Ge=!1,Ue=!1,qt=!0,Wt=!1,Ps="user-content-",dt=!0,Me=!1,ke={},ae=null,ct=A({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),Xt=null,Yt=A({},["audio","video","img","source","image","track"]),pt=null,Vt=A({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),qe="http://www.w3.org/1998/Math/MathML",We="http://www.w3.org/2000/svg",le="http://www.w3.org/1999/xhtml",Ee=le,mt=!1,ut=null,Rs=A({},[qe,We,le],zt),Xe=A({},["mi","mo","mn","ms","mtext"]),Ye=A({},["annotation-xml"]),Ns=A({},["title","style","font","a","script"]),ze=null,Os=["application/xhtml+xml","text/html"],Fs="text/html",P=null,Te=null,Gs=t.createElement("form"),Jt=function(c){return c instanceof RegExp||c instanceof Function},ht=function(){let c=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(Te&&Te===c)){if((!c||typeof c!="object")&&(c={}),c=ne(c),ze=Os.indexOf(c.PARSER_MEDIA_TYPE)===-1?Fs:c.PARSER_MEDIA_TYPE,P=ze==="application/xhtml+xml"?zt:at,R=te(c,"ALLOWED_TAGS")?A({},c.ALLOWED_TAGS,P):Nt,N=te(c,"ALLOWED_ATTR")?A({},c.ALLOWED_ATTR,P):Ot,ut=te(c,"ALLOWED_NAMESPACES")?A({},c.ALLOWED_NAMESPACES,zt):Rs,pt=te(c,"ADD_URI_SAFE_ATTR")?A(ne(Vt),c.ADD_URI_SAFE_ATTR,P):Vt,Xt=te(c,"ADD_DATA_URI_TAGS")?A(ne(Yt),c.ADD_DATA_URI_TAGS,P):Yt,ae=te(c,"FORBID_CONTENTS")?A({},c.FORBID_CONTENTS,P):ct,$e=te(c,"FORBID_TAGS")?A({},c.FORBID_TAGS,P):ne({}),nt=te(c,"FORBID_ATTR")?A({},c.FORBID_ATTR,P):ne({}),ke=te(c,"USE_PROFILES")?c.USE_PROFILES:!1,Ft=c.ALLOW_ARIA_ATTR!==!1,ot=c.ALLOW_DATA_ATTR!==!1,Gt=c.ALLOW_UNKNOWN_PROTOCOLS||!1,Ut=c.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ye=c.SAFE_FOR_TEMPLATES||!1,Fe=c.SAFE_FOR_XML!==!1,he=c.WHOLE_DOCUMENT||!1,we=c.RETURN_DOM||!1,Ge=c.RETURN_DOM_FRAGMENT||!1,Ue=c.RETURN_TRUSTED_TYPE||!1,lt=c.FORCE_BODY||!1,qt=c.SANITIZE_DOM!==!1,Wt=c.SANITIZE_NAMED_PROPS||!1,dt=c.KEEP_CONTENT!==!1,Me=c.IN_PLACE||!1,Rt=c.ALLOWED_URI_REGEXP||Hs,Ee=c.NAMESPACE||le,Xe=c.MATHML_TEXT_INTEGRATION_POINTS||Xe,Ye=c.HTML_INTEGRATION_POINTS||Ye,j=c.CUSTOM_ELEMENT_HANDLING||{},c.CUSTOM_ELEMENT_HANDLING&&Jt(c.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(j.tagNameCheck=c.CUSTOM_ELEMENT_HANDLING.tagNameCheck),c.CUSTOM_ELEMENT_HANDLING&&Jt(c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(j.attributeNameCheck=c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),c.CUSTOM_ELEMENT_HANDLING&&typeof c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(j.allowCustomizedBuiltInElements=c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),ye&&(ot=!1),Ge&&(we=!0),ke&&(R=A({},Ms),N=[],ke.html===!0&&(A(R,$s),A(N,zs)),ke.svg===!0&&(A(R,It),A(N,Ht),A(N,st)),ke.svgFilters===!0&&(A(R,_t),A(N,Ht),A(N,st)),ke.mathMl===!0&&(A(R,Ct),A(N,As),A(N,st))),c.ADD_TAGS&&(typeof c.ADD_TAGS=="function"?xe.tagCheck=c.ADD_TAGS:(R===Nt&&(R=ne(R)),A(R,c.ADD_TAGS,P))),c.ADD_ATTR&&(typeof c.ADD_ATTR=="function"?xe.attributeCheck=c.ADD_ATTR:(N===Ot&&(N=ne(N)),A(N,c.ADD_ATTR,P))),c.ADD_URI_SAFE_ATTR&&A(pt,c.ADD_URI_SAFE_ATTR,P),c.FORBID_CONTENTS&&(ae===ct&&(ae=ne(ae)),A(ae,c.FORBID_CONTENTS,P)),c.ADD_FORBID_CONTENTS&&(ae===ct&&(ae=ne(ae)),A(ae,c.ADD_FORBID_CONTENTS,P)),dt&&(R["#text"]=!0),he&&A(R,["html","head","body"]),R.table&&(A(R,["tbody"]),delete $e.tbody),c.TRUSTED_TYPES_POLICY){if(typeof c.TRUSTED_TYPES_POLICY.createHTML!="function")throw De('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof c.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw De('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');S=c.TRUSTED_TYPES_POLICY,L=S.createHTML("")}else S===void 0&&(S=Va(b,a)),S!==null&&typeof L=="string"&&(L=S.createHTML(""));W&&W(c),Te=c}},Zt=A({},[...It,..._t,...Pa]),Qt=A({},[...Ct,...Ra]),Us=function(c){let x=k(c);(!x||!x.tagName)&&(x={namespaceURI:Ee,tagName:"template"});let E=at(c.tagName),H=at(x.tagName);return ut[c.namespaceURI]?c.namespaceURI===We?x.namespaceURI===le?E==="svg":x.namespaceURI===qe?E==="svg"&&(H==="annotation-xml"||Xe[H]):!!Zt[E]:c.namespaceURI===qe?x.namespaceURI===le?E==="math":x.namespaceURI===We?E==="math"&&Ye[H]:!!Qt[E]:c.namespaceURI===le?x.namespaceURI===We&&!Ye[H]||x.namespaceURI===qe&&!Xe[H]?!1:!Qt[E]&&(Ns[E]||!Zt[E]):!!(ze==="application/xhtml+xml"&&ut[c.namespaceURI]):!1},ie=function(c){je(e.removed,{element:c});try{k(c).removeChild(c)}catch{v(c)}},ge=function(c,x){try{je(e.removed,{attribute:x.getAttributeNode(c),from:x})}catch{je(e.removed,{attribute:null,from:x})}if(x.removeAttribute(c),c==="is")if(we||Ge)try{ie(x)}catch{}else try{x.setAttribute(c,"")}catch{}},Kt=function(c){let x=null,E=null;if(lt)c="<remove></remove>"+c;else{let B=At(c,/^[\r\n\t ]+/);E=B&&B[0]}ze==="application/xhtml+xml"&&Ee===le&&(c='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+c+"</body></html>");let H=S?S.createHTML(c):c;if(Ee===le)try{x=new f().parseFromString(H,ze)}catch{}if(!x||!x.documentElement){x=se.createDocument(Ee,"template",null);try{x.documentElement.innerHTML=mt?L:H}catch{}}let G=x.body||x.documentElement;return c&&E&&G.insertBefore(t.createTextNode(E),G.childNodes[0]||null),Ee===le?re.call(x,he?"html":"body")[0]:he?x.documentElement:G},es=function(c){return oe.call(c.ownerDocument||c,c,r.SHOW_ELEMENT|r.SHOW_COMMENT|r.SHOW_TEXT|r.SHOW_PROCESSING_INSTRUCTION|r.SHOW_CDATA_SECTION,null)},gt=function(c){return c instanceof m&&(typeof c.nodeName!="string"||typeof c.textContent!="string"||typeof c.removeChild!="function"||!(c.attributes instanceof p)||typeof c.removeAttribute!="function"||typeof c.setAttribute!="function"||typeof c.namespaceURI!="string"||typeof c.insertBefore!="function"||typeof c.hasChildNodes!="function")},ts=function(c){return typeof l=="function"&&c instanceof l};function de(M,c,x){tt(M,E=>{E.call(e,c,x,Te)})}let ss=function(c){let x=null;if(de(z.beforeSanitizeElements,c,null),gt(c))return ie(c),!0;let E=P(c.nodeName);if(de(z.uponSanitizeElement,c,{tagName:E,allowedTags:R}),Fe&&c.hasChildNodes()&&!ts(c.firstElementChild)&&q(/<[/\w!]/g,c.innerHTML)&&q(/<[/\w!]/g,c.textContent)||c.nodeType===Re.progressingInstruction||Fe&&c.nodeType===Re.comment&&q(/<[/\w]/g,c.data))return ie(c),!0;if(!(xe.tagCheck instanceof Function&&xe.tagCheck(E))&&(!R[E]||$e[E])){if(!$e[E]&&is(E)&&(j.tagNameCheck instanceof RegExp&&q(j.tagNameCheck,E)||j.tagNameCheck instanceof Function&&j.tagNameCheck(E)))return!1;if(dt&&!ae[E]){let H=k(c)||c.parentNode,G=w(c)||c.childNodes;if(G&&H){let B=G.length;for(let V=B-1;V>=0;--V){let ce=h(G[V],!0);ce.__removalCount=(c.__removalCount||0)+1,H.insertBefore(ce,y(c))}}}return ie(c),!0}return c instanceof o&&!Us(c)||(E==="noscript"||E==="noembed"||E==="noframes")&&q(/<\/no(script|embed|frames)/i,c.innerHTML)?(ie(c),!0):(ye&&c.nodeType===Re.text&&(x=c.textContent,tt([g,T,$],H=>{x=Be(x,H," ")}),c.textContent!==x&&(je(e.removed,{element:c.cloneNode()}),c.textContent=x)),de(z.afterSanitizeElements,c,null),!1)},as=function(c,x,E){if(qt&&(x==="id"||x==="name")&&(E in t||E in Gs))return!1;if(!(ot&&!nt[x]&&q(F,x))){if(!(Ft&&q(Z,x))){if(!(xe.attributeCheck instanceof Function&&xe.attributeCheck(x,c))){if(!N[x]||nt[x]){if(!(is(c)&&(j.tagNameCheck instanceof RegExp&&q(j.tagNameCheck,c)||j.tagNameCheck instanceof Function&&j.tagNameCheck(c))&&(j.attributeNameCheck instanceof RegExp&&q(j.attributeNameCheck,x)||j.attributeNameCheck instanceof Function&&j.attributeNameCheck(x,c))||x==="is"&&j.allowCustomizedBuiltInElements&&(j.tagNameCheck instanceof RegExp&&q(j.tagNameCheck,E)||j.tagNameCheck instanceof Function&&j.tagNameCheck(E))))return!1}else if(!pt[x]){if(!q(Rt,Be(E,Le,""))){if(!((x==="src"||x==="xlink:href"||x==="href")&&c!=="script"&&Ha(E,"data:")===0&&Xt[c])){if(!(Gt&&!q(ue,Be(E,Le,"")))){if(E)return!1}}}}}}}return!0},is=function(c){return c!=="annotation-xml"&&At(c,Oe)},ns=function(c){de(z.beforeSanitizeAttributes,c,null);let{attributes:x}=c;if(!x||gt(c))return;let E={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:N,forceKeepAttr:void 0},H=x.length;for(;H--;){let G=x[H],{name:B,namespaceURI:V,value:ce}=G,Se=P(B),ft=ce,O=B==="value"?ft:ja(ft);if(E.attrName=Se,E.attrValue=O,E.keepAttr=!0,E.forceKeepAttr=void 0,de(z.uponSanitizeAttribute,c,E),O=E.attrValue,Wt&&(Se==="id"||Se==="name")&&(ge(B,c),O=Ps+O),Fe&&q(/((--!?|])>)|<\/(style|title|textarea)/i,O)){ge(B,c);continue}if(Se==="attributename"&&At(O,"href")){ge(B,c);continue}if(E.forceKeepAttr)continue;if(!E.keepAttr){ge(B,c);continue}if(!Ut&&q(/\/>/i,O)){ge(B,c);continue}ye&&tt([g,T,$],rs=>{O=Be(O,rs," ")});let os=P(c.nodeName);if(!as(os,Se,O)){ge(B,c);continue}if(S&&typeof b=="object"&&typeof b.getAttributeType=="function"&&!V)switch(b.getAttributeType(os,Se)){case"TrustedHTML":{O=S.createHTML(O);break}case"TrustedScriptURL":{O=S.createScriptURL(O);break}}if(O!==ft)try{V?c.setAttributeNS(V,B,O):c.setAttribute(B,O),gt(c)?ie(c):Ls(e.removed)}catch{ge(B,c)}}de(z.afterSanitizeAttributes,c,null)},qs=function M(c){let x=null,E=es(c);for(de(z.beforeSanitizeShadowDOM,c,null);x=E.nextNode();)de(z.uponSanitizeShadowNode,x,null),ss(x),ns(x),x.content instanceof i&&M(x.content);de(z.afterSanitizeShadowDOM,c,null)};return e.sanitize=function(M){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},x=null,E=null,H=null,G=null;if(mt=!M,mt&&(M="<!-->"),typeof M!="string"&&!ts(M))if(typeof M.toString=="function"){if(M=M.toString(),typeof M!="string")throw De("dirty is not a string, aborting")}else throw De("toString is not a function");if(!e.isSupported)return M;if(rt||ht(c),e.removed=[],typeof M=="string"&&(Me=!1),Me){if(M.nodeName){let ce=P(M.nodeName);if(!R[ce]||$e[ce])throw De("root node is forbidden and cannot be sanitized in-place")}}else if(M instanceof l)x=Kt("<!---->"),E=x.ownerDocument.importNode(M,!0),E.nodeType===Re.element&&E.nodeName==="BODY"||E.nodeName==="HTML"?x=E:x.appendChild(E);else{if(!we&&!ye&&!he&&M.indexOf("<")===-1)return S&&Ue?S.createHTML(M):M;if(x=Kt(M),!x)return we?null:Ue?L:""}x&&lt&&ie(x.firstChild);let B=es(Me?M:x);for(;H=B.nextNode();)ss(H),ns(H),H.content instanceof i&&qs(H.content);if(Me)return M;if(we){if(Ge)for(G=Y.call(x.ownerDocument);x.firstChild;)G.appendChild(x.firstChild);else G=x;return(N.shadowroot||N.shadowrootmode)&&(G=J.call(s,G,!0)),G}let V=he?x.outerHTML:x.innerHTML;return he&&R["!doctype"]&&x.ownerDocument&&x.ownerDocument.doctype&&x.ownerDocument.doctype.name&&q(js,x.ownerDocument.doctype.name)&&(V="<!DOCTYPE "+x.ownerDocument.doctype.name+`>
`+V),ye&&tt([g,T,$],ce=>{V=Be(V,ce," ")}),S&&Ue?S.createHTML(V):V},e.setConfig=function(){let M=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};ht(M),rt=!0},e.clearConfig=function(){Te=null,rt=!1},e.isValidAttribute=function(M,c,x){Te||ht({});let E=P(M),H=P(c);return as(E,H,x)},e.addHook=function(M,c){typeof c=="function"&&je(z[M],c)},e.removeHook=function(M,c){if(c!==void 0){let x=_a(z[M],c);return x===-1?void 0:Ca(z[M],x,1)[0]}return Ls(z[M])},e.removeHooks=function(M){z[M]=[]},e.removeAllHooks=function(){z=_s()},e}var Ds=Bs();_.setOptions({breaks:!0,gfm:!0});function me(d){let e=[],t=d.replace(/```[\s\S]*?```/g,i=>(e.push(i),`%%CODEBLOCK_${e.length-1}%%`)),s=[];t=t.replace(/`[^`]+`/g,i=>(s.push(i),`%%INLINECODE_${s.length-1}%%`)),t=t.replace(/@([a-zA-Z0-9_]+)/g,'<a href="#" class="mention" data-mention="$1">@$1</a>').replace(/#([a-zA-Z0-9_]+)/g,'<a href="#" class="hashtag" data-tag="$1">#$1</a>'),s.forEach((i,n)=>{t=t.replace(`%%INLINECODE_${n}%%`,i)}),e.forEach((i,n)=>{t=t.replace(`%%CODEBLOCK_${n}%%`,i)});let a=_.parse(t);return Ds.sanitize(a,{ADD_ATTR:["data-mention","data-tag"],ADD_TAGS:["img"],ADD_URI_SAFE_ATTR:["src"]})}function C(d,e="success"){let t=document.createElement("div"),a={success:{bg:"rgba(16,185,129,0.15)",border:"#10b981",text:"#34d399",icon:"M5 13l4 4L19 7"},error:{bg:"rgba(16,185,129,0.15)",border:"#059669",text:"#f87171",icon:"M6 18L18 6M6 6l12 12"},info:{bg:"rgba(59,130,246,0.15)",border:"#3b82f6",text:"#60a5fa",icon:"M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"}}[e];t.style.cssText=`
    position: fixed; top: 20px; right: 20px; z-index: 99999;
    background: ${a.bg}; backdrop-filter: blur(20px);
  ...
  `,t.innerHTML=`
    ...
    <svg width="18" height="18" fill="none" stroke="${a.text}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="${a.icon}"/></svg>
    <span style="color: ${a.text}; font-size: 13px; font-weight: 600;">${d}</span>
  `,document.body.appendChild(t),setTimeout(()=>{t.style.animation="toastSlideOut 0.3s ease-in forwards",setTimeout(()=>t.remove(),300)},3e3)}function D(d,e="info",t){let s=document.getElementById("epic-modal-overlay");s&&s.remove();let i={error:{bg:"#059669",glow:"rgba(16,185,129,0.5)",icon:"M6 18L18 6M6 6l12 12"},success:{bg:"#10b981",glow:"rgba(16,185,129,0.5)",icon:"M5 13l4 4L19 7"},warning:{bg:"#f59e0b",glow:"rgba(245,158,11,0.5)",icon:"M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"},info:{bg:"#3b82f6",glow:"rgba(59,130,246,0.5)",icon:"M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"}}[e],n=t||(e==="error"?"Error":e==="success"?"Success":e==="warning"?"Warning":"Notice"),l=document.createElement("div");l.id="epic-modal-overlay",l.style.cssText=`
  ...
  `,l.innerHTML=`
    <style>
      ...
      @keyframes epicPulse { 0%, 100% { box-shadow: 0 0 20px ${i.glow}; } 50% { box-shadow: 0 0 40px ${i.glow}, 0 0 60px ${i.glow}; } }
    ...
    <div style="
      ...
      box-shadow: 0 25px 50px -12px rgba(0,0,0,0.5), 0 0 30px ${i.glow};
    ">
      <div style="
        width: 72px; height: 72px; border-radius: 50%; margin: 0 auto 20px;
        background: linear-gradient(135deg, ${i.bg}, ${i.bg}cc);
        display: flex; align-items: center; justify-content: center;
        animation: epicIconPop 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) 0.2s both, epicPulse 2s ease-in-out infinite;
        box-shadow: 0 8px 32px ${i.glow};
      ">
  ...
  `,document.body.appendChild(l);let o=document.getElementById("epic-modal-close"),r=()=>{l.style.animation="epicFadeIn 0.2s ease-out reverse",setTimeout(()=>l.remove(),200)};o?.addEventListener("click",r),l.addEventListener("click",p=>{p.target===l&&r()}),document.addEventListener("keydown",function p(m){m.key==="Escape"&&(r(),document.removeEventListener("keydown",p))})}var ve="devnetwork_hash",Ne="devnetwork_device_token",it=[{id:"field",question:"What best describes you?",options:[{label:"Founder / CEO",value:"founder"},{label:"Developer / Engineer",value:"developer"},{label:"Designer / Creative",value:"designer"},{label:"Marketer / Growth",value:"marketer"},{label:"Product Manager",value:"product"},{label:"Freelancer / Agency",value:"freelancer"}]},{id:"experience",question:"Where are you on your journey?",options:[{label:"Just getting started \u2014 exploring ideas",value:"exploring"},{label:"Building my first product",value:"building"},{label:"Shipped something, finding PMF",value:"shipped"},{label:"Scaling \u2014 revenue or team growing",value:"scaling"}]},{id:"skills",question:"What's in your toolkit? (pick all that apply)",multiSelect:!0,options:[{label:"Full-Stack Development",value:"fullstack"},{label:"Frontend / UI",value:"frontend"},{label:"Backend / APIs",value:"backend"},{label:"Mobile Apps",value:"mobile"},{label:"AI / Machine Learning",value:"ai"},{label:"UI/UX Design",value:"design"},{label:"No-Code / Low-Code",value:"nocode"},{label:"Growth & Marketing",value:"growth"},{label:"Sales & Biz Dev",value:"sales"},{label:"Content & Copywriting",value:"content"},{label:"DevOps / Cloud",value:"devops"},{label:"Data & Analytics",value:"data"}]},{id:"focus",question:"What are you here for?",options:[{label:"Find a co-founder or teammates",value:"cofounder"},{label:"Get feedback on what I'm building",value:"feedback"},{label:"Connect with other builders",value:"network"},{label:"Find clients or freelance gigs",value:"clients"}]},{id:"interests",question:"What fires you up? (pick all that apply)",multiSelect:!0,options:[{label:"SaaS & Micro-SaaS",value:"saas"},{label:"Indie Hacking",value:"indiehacking"},{label:"AI Products & Tools",value:"ai-products"},{label:"Developer Tools",value:"devtools"},{label:"E-Commerce / DTC",value:"ecommerce"},{label:"Content Creation",value:"content"},{label:"Open Source",value:"opensource"},{label:"Web3 / Crypto",value:"web3"},{label:"Building in Public",value:"buildinpublic"},{label:"Revenue & Monetization",value:"revenue"},{label:"Fundraising & VCs",value:"fundraising"},{label:"Remote & Async Work",value:"remote"}]},{id:"teamSize",question:"How do you like to build?",options:[{label:"Solo \u2014 I do everything myself",value:"solo"},{label:"Small crew (2-4 people)",value:"small"},{label:"Growing team (5-15)",value:"medium"},{label:"I'm flexible",value:"any"}]}],Ja=[{question:"You have a startup idea at 2am. First thing you do?",options:["Open VS Code and start building a prototype \u{1F4BB}","Write down the value prop and target market \u{1F4DD}","Search if someone already built it \u{1F50D}"],hint:"This reveals how you think...",forFields:["software","design","marketing","data","product","devops"]},{question:"Your MVP is ready but the code is messy. You...",options:["Ship it now, refactor later \u2014 users first \u{1F680}","Clean the codebase before anyone sees it \u{1F9F9}","Get 5 users to test it while I fix things in parallel \u26A1"],hint:"Speed vs. craft...",forFields:["software","design","marketing","data","product","devops"]},{question:"A co-founder disagrees on the product direction. You...",options:["Show them the data and let numbers decide \u{1F4CA}","Prototype both ideas and A/B test with users \u{1F9EA}","Have a deep conversation about the vision and align \u{1F91D}"],hint:"How you resolve conflict matters...",forFields:["software","design","marketing","data","product","devops"]},{question:"You just got your first 100 users. Next move?",options:["Talk to every single user to understand their pain \u{1F3AF}","Build the features they're asking for ASAP \u{1F3D7}\uFE0F","Write a launch thread and start building in public \u{1F4E3}"],hint:"Growth mode activated...",forFields:["software","design","marketing","data","product","devops"]},{question:"What's your unfair advantage as a builder?",options:["I can ship a full product solo \u2014 design to deploy \u{1F6E0}\uFE0F","I understand users better than most engineers do \u{1F9E0}","I can get people excited about anything I'm building \u{1F525}"],hint:"Everyone's got one...",forFields:["software","design","marketing","data","product","devops"]}];var Pt=class{appState;wizardState=null;container;selectedSkills=[];feedSocket=null;posts=[];_notifDebounce=null;_currentView="";activeEcosystem=null;userEcosystems=[];defaultEcosystemId="";constructor(){this.appState={mode:"loading",user:null,hash:null},this.container=document.getElementById("wizard-container")||document.getElementById("main-content"),this.init()}setContent(e,t){t&&(this._currentView=t),this.container.scrollTop=0,this.container.innerHTML=e}async init(){try{let t=await fetch("/api/config");if(t.ok){let s=await t.json();this.defaultEcosystemId=s.default_ecosystem_id||""}}catch{}let e=localStorage.getItem(ve);if(e){let t=await this.validateHash(e);if(t.requires_2fa){this.showLogin2FA(e);return}if(t.user){this.appState={mode:"app",user:t.user,hash:e},this.showApp();return}localStorage.removeItem(ve)}this.appState.mode="wizard",this.startWizard()}async validateHash(e,t){try{let s=localStorage.getItem(Ne),a=await fetch("/api/auth/validate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({hash:e,totp_code:t,device_token:s})});if(a.ok){let i=await a.json();return i.requires_2fa?{user:null,requires_2fa:!0}:{user:i.user}}}catch(s){console.error("Auth validation failed:",s)}return{user:null}}showLogin2FA(e){this.container.innerHTML=`
    ...
    `;let t=document.getElementById("login-2fa-form"),s=document.getElementById("login-totp-code");s.addEventListener("input",a=>{let i=a.target;i.value=i.value.replace(/\D/g,"").slice(0,6)}),t.addEventListener("submit",async a=>{a.preventDefault();let i=s.value,n=document.getElementById("login-2fa-error"),l=t.querySelector('button[type="submit"]');if(i.length!==6){n.textContent="Please enter a 6-digit code",n.classList.remove("hidden");return}l.disabled=!0,l.innerHTML='<svg class="w-5 h-5 animate-spin mx-auto" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path></svg>',n.classList.add("hidden");try{let o=await fetch("/api/auth/verify-login-2fa",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({hash:e,code:i})}),r=await o.json();if(o.ok&&r.success)r.device_token&&localStorage.setItem(Ne,r.device_token),this.appState={mode:"app",user:r.user,hash:e},this.showApp();else throw new Error(r.error||"Invalid code")}catch(o){n.textContent=o.message||"Invalid code. Please try again.",n.classList.remove("hidden"),l.disabled=!1,l.innerHTML='<svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"/></svg> Sign In',s.value="",s.focus()}}),document.getElementById("use-different-device")?.addEventListener("click",()=>{localStorage.removeItem(ve),localStorage.removeItem(Ne),this.appState.mode="wizard",this.startWizard()}),s.focus()}generateSessionId(){return"session_"+Math.random().toString(36).substring(2,15)+Date.now().toString(36)}async getFingerprint(){let e=document.createElement("canvas"),t=e.getContext("2d");t.textBaseline="top",t.font="14px Arial",t.fillText("DevNetwork fingerprint",2,2);let s=e.toDataURL(),a=`${screen.width}x${screen.height}x${screen.colorDepth}`,i=Intl.DateTimeFormat().resolvedOptions().timeZone,n=navigator.language,l=navigator.platform,o=`${s}|${a}|${i}|${n}|${l}`,p=new TextEncoder().encode(o),m=await crypto.subtle.digest("SHA-256",p);return Array.from(new Uint8Array(m)).map(b=>b.toString(16).padStart(2,"0")).join("")}delay(e){return new Promise(t=>setTimeout(t,e))}startWizard(){this.wizardState={sessionId:this.generateSessionId(),phase:"intro",qualifierStep:0,challengeStep:0,profile:{field:"",experience:"",skills:[],focus:"",interests:[],teamSize:""},talents:[],answers:[]},this.showWizardIntro()}showWizardIntro(){this.container.innerHTML=`
    ...
    `;let e=this.container.querySelector("video");if(e){let s=document.createElement("source");s.src="/static/devnet-intro.mp4",s.type="video/mp4",e.appendChild(s),e.load()}document.getElementById("start-wizard-btn").addEventListener("click",()=>{this.wizardState.phase="qualifier",this.showQualifier()}),document.getElementById("link-device-btn").addEventListener("click",()=>{this.showLinkDevice()});let t=document.getElementById("wizard-glitter-canvas");if(t){let s=t.getContext("2d"),a,i,n=[],l=()=>{t.parentElement&&(a=t.width=t.parentElement.offsetWidth,i=t.height=t.parentElement.offsetHeight)};l(),window.addEventListener("resize",l);for(let r=0;r<300;r++)n.push({x:Math.random()*(a||800),y:Math.random()*(i||600),r:Math.random()*2+.5,dx:(Math.random()-.5)*.4,dy:(Math.random()-.5)*.4,twinkle:Math.random()*Math.PI*2,speed:.02+Math.random()*.04,green:Math.random()>.5});let o=()=>{if(document.getElementById("wizard-glitter-canvas")){s.clearRect(0,0,a,i);for(let r of n){r.x+=r.dx,r.y+=r.dy,r.twinkle+=r.speed,r.x<0&&(r.x=a),r.x>a&&(r.x=0),r.y<0&&(r.y=i),r.y>i&&(r.y=0);let p=.3+Math.abs(Math.sin(r.twinkle))*.7;s.beginPath(),s.arc(r.x,r.y,r.r,0,Math.PI*2),s.fillStyle=r.green?`rgba(16,185,129,${p})`:`rgba(255,255,255,${p})`,s.fill()}requestAnimationFrame(o)}};o()}}showLinkDevice(){this.container.innerHTML=`
      ...
      <div class="max-w-lg mx-auto px-4 py-8" style="max-height:100vh;overflow-y:auto;">
        <div class="card slide-up">
          <div class="mb-8">
            <div class="flex items-center justify-between text-sm text-zinc-400 mb-3">
              ...
              <span class="bg-zinc-800 px-3 py-1 rounded-full font-medium text-emerald-400">
                ${this.wizardState.qualifierStep+1} / ${it.length}
              </span>
            </div>
          ...
          <div class="space-y-3" id="options-container">
            ${e.options.map((i,n)=>`
              <button class="wizard-option touch-bounce flex items-center gap-4 stagger-${Math.min(n+1,5)}" data-value="${i.value}" data-index="${n}" style="animation: slide-in-right 0.4s ease-out backwards; animation-delay: ${n*.08}s">
                <span class="option-emoji text-2xl">${a[n]||"\u2728"}</span>
                ${e.multiSelect?`
                ...
                `:""}
                <span class="text-zinc-200 font-medium flex-1 text-left">${i.label}</span>
    ...
    `,await this.delay(2e3),this.wizardState.phase="challenge",this.showCurrentPuzzle())}getFieldLabel(){return{founder:"Founder",developer:"Developer",designer:"Designer",marketer:"Growth Marketer",product:"Product Manager",freelancer:"Freelancer"}[this.wizardState?.profile.field||""]||"Builder"}getExperienceLabel(){return{exploring:"exploring ideas",building:"building first product",shipped:"finding product-market fit",scaling:"scaling up"}[this.wizardState?.profile.experience||""]||""}getRelevantPuzzles(){return[...Ja].slice(0,5)}showCurrentPuzzle(){if(!this.wizardState)return;let e=this.getRelevantPuzzles();if(this.wizardState.challengeStep>=e.length){this.showCompletion();return}let t=e[this.wizardState.challengeStep],s=this.wizardState.challengeStep/e.length*100;this.container.innerHTML=`
      <div class="max-w-lg mx-auto px-4 py-8">
        <div class="card-elevated slide-up">
          <div class="mb-6">
          ...
          <div class="space-y-3" id="puzzle-options">
            ${t.options.map((i,n)=>`
              <button class="wizard-option flex items-center gap-3" data-option="${n}">
                ...
                <span class="text-warm-gray-700">${i}</span>
              </button>
            `).join("")}
          </div>
          ...
          ${this.wizardState.talents.length>0?`
            <div class="mt-6 pt-4 border-t border-warm-gray-100">
              ...
              <div class="flex flex-wrap gap-2">
                ${this.wizardState.talents.map(i=>`
                  <span class="badge badge-talent">${i}</span>
                `).join("")}
              </div>
            </div>
          `:""}
    ...
    `,this.container.querySelectorAll(".wizard-option").forEach(i=>{i.addEventListener("click",n=>{let l=n.currentTarget,o=parseInt(l.dataset.option);this.selectPuzzleOption(o)})});let a=i=>{let n=i.key.toUpperCase();if(n>="A"&&n<="C"){let l=n.charCodeAt(0)-65;l<t.options.length&&(this.selectPuzzleOption(l),document.removeEventListener("keydown",a))}};document.addEventListener("keydown",a)}async selectPuzzleOption(e){if(!this.wizardState)return;let a=this.getRelevantPuzzles()[this.wizardState.challengeStep].options[e];this.wizardState.answers.push(a),this.container.querySelector(`[data-option="${e}"]`).classList.add("selected");try{let l=await(await fetch("/api/wizard/step",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({session_id:this.wizardState.sessionId,step:this.wizardState.challengeStep+1,answer:a,phase:"challenge"})})).json();l.talent_discovered&&(this.wizardState.talents.push(l.talent_discovered),await this.showTalentReveal(l.talent_discovered))}catch(n){console.error("Failed to submit:",n)}this.wizardState.challengeStep++,await this.delay(300),this.showCurrentPuzzle()}async showTalentReveal(e){let t=document.createElement("div");t.className="fixed inset-0 bg-black/50 flex items-center justify-center z-50 fade-in",t.innerHTML=`
    ...
    `,document.getElementById("complete-form").addEventListener("submit",e=>{e.preventDefault(),this.completeWizard()}))}async completeWizard(){if(!this.wizardState)return;let e=document.getElementById("complete-form"),t=new FormData(e),s=await this.getFingerprint(),a=t.get("displayName"),i=e.querySelector('button[type="submit"]'),n=e.querySelector(".error-message");i.disabled=!0,i.innerHTML=`
      <svg class="w-5 h-5 animate-spin mx-auto" fill="none" viewBox="0 0 24 24">
        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path>
      </svg>
    `;try{let o=await(await fetch("/api/auth/check-username",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:a})})).json();if(!o.available)throw new Error(o.error||"Username already taken. Please choose a different name.");let r=await fetch("/api/auth/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({fingerprint:s,session_id:this.wizardState.sessionId,profile:{displayName:t.get("displayName"),bio:t.get("bio")||"",email:t.get("email")||"",portfolio:t.get("portfolio"),...this.wizardState.profile},age_confirmed:!0,talents:this.wizardState.talents})});if(r.ok){let p=await r.json();p.requires_2fa?this.show2FASetup(p.user,p.hash,p.totp_secret):(localStorage.setItem(ve,p.hash),this.appState={mode:"app",user:p.user,hash:p.hash},this.showWelcome(p.user))}else{let p=await r.json();throw new Error(p.error||"Registration failed")}}catch(l){console.error("Registration failed:",l),i.disabled=!1,i.textContent="Try Again",n&&(n.textContent=l.message||"Registration failed",n.classList.remove("hidden"))}}show2FASetup(e,t,s){let a=`otpauth://totp/DevNetwork:${encodeURIComponent(e.displayName)}?secret=${s}&issuer=DevNetwork`;this.container.innerHTML=`
            ...
            <div class="bg-zinc-800/50 rounded-xl p-3 sm:p-4 border border-zinc-700/50">
              ...
              <div id="qr-container" class="hidden mb-3">
                <div class="bg-white p-3 rounded-xl inline-block mx-auto">
                  <img id="qr-code-img" src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(a)}" alt="QR Code" class="w-36 h-36 sm:w-44 sm:h-44">
                </div>
              </div>
          ...
          ${s>0?`
            <div class="mb-6">
              ...
              <div class="flex flex-wrap justify-center gap-2 max-h-48 overflow-y-auto">
                ${t.map((a,i)=>`
                  <div class="group-chip inline-flex items-center gap-2 px-3 py-2 bg-zinc-800/80 hover:bg-zinc-700 rounded-lg border border-zinc-700 hover:border-emerald-500/50 transition-all cursor-pointer" style="animation-delay: ${i*.05}s" title="${a.description||""}">
                    ...
                    <span class="text-sm text-zinc-200">${a.name}</span>
                  </div>
                `).join("")}
              </div>
            </div>
      ...
      <div class="h-full w-full flex flex-col">
        <div class="panel flex-1">
          ...
          <div class="panel-body">
            ...
            `:t.notifications.map(s=>{let a=s.data?.from_user_name||s.data?.from_user||s.from_user?.displayName||s.last_sender||"Someone",i=s.data?.from_id||s.data?.from_user_id||s.from_user?.id||"",n=s.data?.preview||s.preview||"",l=s.type==="group_message",o=s.group_id||"",r=s.group_name||"Group",p=s.count||1;return`
              <div class="notification-item cursor-pointer hover:bg-zinc-800/50 transition-colors ${s.read?"":"unread"}" data-notification-id="${s.id}" ${l?`data-group-id="${o}"`:`data-from-id="${i}"`} data-type="${s.type||"dm"}">
                <div class="flex items-start gap-3">
                  <div class="relative w-8 h-8 rounded-lg ${l?"bg-blue-500/20":s.type==="bot_approved"?"bg-purple-500/20":"bg-emerald-500/20"} flex items-center justify-center flex-shrink-0">
                    ${l?`
                      ...
                      ${p>1?`<span class="absolute -top-1 -right-1 bg-blue-500 text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center">${p>9?"9+":p}</span>`:""}
                    `:s.type==="bot_approved"?`
    ...
    `),window.lucide&&window.lucide.createIcons(),document.querySelectorAll(".dm-conversation-item").forEach(s=>{s.addEventListener("click",a=>{a.preventDefault(),a.stopPropagation();let i=s.dataset.convId||"",n=s.dataset.otherId||"",l=s.dataset.otherName||"User";i&&n&&this.openDMChat(i,n,l)})})}async openDM(e){if(!e)return;let t=await fetch("/api/dm/conversations",{headers:{"X-Auth-Hash":this.appState.hash||""}}),a=(t.ok?await t.json():[]).find(i=>i.other_user?.id===e);if(a)this.openDMChat(a.id,a.other_user.id,a.other_user.displayName);else{let i=await fetch("/api/dm/start",{method:"POST",headers:{"Content-Type":"application/json","X-Auth-Hash":this.appState.hash||""},body:JSON.stringify({user_id:e})});if(i.ok){let n=await i.json();this.openDMChat(n.id,n.other_user.id,n.other_user.displayName)}}}async openDMChat(e,t,s){let a=await fetch(`/api/dm/${e}/messages`,{headers:{"X-Auth-Hash":this.appState.hash||""}}),i=a.ok?await a.json():[];window.dmPanelInstance={currentConversation:{id:e,otherId:t,otherName:s},addMessageToUI:r=>{if(r.type==="dm_reaction_update"){let m=document.querySelector(`.dm-reactions-display[data-dm-msg-id="${r.message_id}"]`);m&&this.renderReactionBadges(m,r.reactions,"dm",r.message_id,r.conv_id);return}let p=document.getElementById("dm-messages");if(p){let m=p.querySelector(".text-center");m&&m.remove(),p.insertAdjacentHTML("beforeend",this.renderDMMessage(r)),p.scrollTop=p.scrollHeight,this.attachDMReactionListeners(e)}}},this.setContent(`
      <div class="h-full w-full flex flex-col">
        <div class="flex-1 flex flex-col overflow-hidden bg-zinc-900 border-l border-zinc-800">
          <div class="panel-header">
            <div class="flex items-center gap-3">
          ...
          <div id="dm-messages" class="panel-body flex-1 overflow-y-auto flex flex-col gap-2 p-4">
            ...
            `:i.map(r=>this.renderDMMessage(r)).join("")}
          </div>
    ...
    `);let n=document.getElementById("dm-messages");n&&(n.scrollTop=n.scrollHeight),this.attachDMReactionListeners(e),document.getElementById("dm-back-btn")?.addEventListener("click",()=>this.showMessages()),document.getElementById("view-dm-profile")?.addEventListener("click",()=>this.viewUserProfile(t));let l=null;document.getElementById("dm-image-btn")?.addEventListener("click",()=>{document.getElementById("dm-image-input")?.click()}),document.getElementById("dm-image-input")?.addEventListener("change",async r=>{let p=r.target.files?.[0];if(!p)return;let m=document.getElementById("dm-image-btn");m&&(m.innerHTML='<div class="w-5 h-5 border-2 border-emerald-400 border-t-transparent rounded-full animate-spin"></div>');try{let f=new FormData;f.append("file",p);let b=await fetch("/api/upload/image",{method:"POST",headers:{"X-Auth-Hash":this.appState.hash||""},body:f});if(b.ok){let u=await b.json();l=u.url;let h=document.getElementById("dm-image-preview"),v=document.getElementById("dm-image-preview-img");h&&v&&(v.src=u.url,h.classList.remove("hidden"))}}catch(f){console.error("Image upload failed",f)}m&&(m.innerHTML='<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>')}),document.getElementById("dm-image-remove")?.addEventListener("click",()=>{l=null,document.getElementById("dm-image-preview")?.classList.add("hidden")}),document.getElementById("dm-gif-btn")?.addEventListener("click",r=>{let p=r.currentTarget;this.openGifDrawer("dm",p,{convId:e,setPendingImage:m=>{l=m}})});let o=async()=>{let r=document.getElementById("dm-input"),p=r?.value.trim();if(!p&&!l)return;r.value="";let m=l;l=null,document.getElementById("dm-image-preview")?.classList.add("hidden");let f=await fetch(`/api/dm/${e}/messages`,{method:"POST",headers:{"Content-Type":"application/json","X-Auth-Hash":this.appState.hash||""},body:JSON.stringify({content:p,image_url:m})});if(f.ok){let b=await f.json(),u=document.getElementById("dm-messages");if(u){let h=u.querySelector(".text-center");h&&h.remove(),b.user_message&&b.bot_reply?(u.insertAdjacentHTML("beforeend",this.renderDMMessage(b.user_message)),u.insertAdjacentHTML("beforeend",this.renderDMMessage(b.bot_reply))):u.insertAdjacentHTML("beforeend",this.renderDMMessage(b)),u.scrollTop=u.scrollHeight}}};document.getElementById("dm-send-btn")?.addEventListener("click",o),document.getElementById("dm-input")?.addEventListener("keydown",r=>{r.key==="Enter"&&o()})}renderDMMessage(e){let t=e.user_id===this.appState.user?.id,s=this.parseMarkdown(e.content||""),a=this.escapeHtml(e.id||"");return`
      <div class="dm-msg-wrapper flex ${t?"justify-end":"justify-start"}" data-dm-msg-id="${a}" style="position:relative;">
        <div style="max-width:70%;position:relative;">
          ...
          <div class="dm-reactions-display" data-dm-msg-id="${a}" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:4px;${t?"justify-content:flex-end;":""}"></div>
          <button class="dm-reaction-btn" data-dm-msg-id="${a}" style="display:none;position:absolute;${t?"left:-28px;":"right:-28px;"}bottom:4px;width:24px;height:24px;border-radius:50%;background:#27272a;border:1px solid #3f3f46;cursor:pointer;align-items:center;justify-content:center;font-size:12px;z-index:10;transition:all 0.15s;" title="React">
              ...
              <div class="flex-1">
                ...
                ${s.skills?.length>0?`
                  <div class="flex flex-wrap gap-1 mt-2">
                    ${s.skills.map(i=>`<span class="px-2 py-0.5 bg-emerald-500/20 border border-emerald-500/30 rounded text-xs text-emerald-400">${this.escapeHtml(i)}</span>`).join("")}
                  </div>
                `:""}
              </div>
            </div>
          ...
          <div class="panel-body p-4">
            ...
            <div class="bg-zinc-800/50 rounded-lg p-4 mb-4 border border-zinc-700">
              ...
              <div id="eco-grid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                `:a.map(n=>{let l=this.userEcosystems.some(o=>o.id===n.id);return`
    ...
    `),window.lucide&&window.lucide.createIcons(),document.querySelectorAll(".trending-tag").forEach(n=>{n.addEventListener("click",()=>{let l=n.dataset.tag;l&&this.showHashtagFeed(l)})}),document.getElementById("create-eco-btn")?.addEventListener("click",()=>this.showCreateEcosystem());let i=document.getElementById("eco-filter");i&&i.addEventListener("input",()=>{let n=i.value.trim().toLowerCase();document.querySelectorAll(".eco-card").forEach(l=>{let o=l.dataset.ecoName||"";l.style.display=!n||o.includes(n)?"":"none"})}),document.querySelectorAll(".eco-join-btn").forEach(n=>{n.addEventListener("click",async l=>{l.stopPropagation();let o=n.dataset.ecoId,r=n.dataset.isMember==="true";if(!o)return;let p=r?`/api/ecosystems/${o}/leave`:`/api/ecosystems/${o}/join`,m=await fetch(p,{method:"POST",headers:{"X-Auth-Hash":this.appState.hash||""}});if(m.ok)await this.loadUserEcosystems(),this.showExplore();else{let f=await m.json().catch(()=>({detail:"Failed"}));C(f.detail||"Action failed","error")}})}),this.setupExploreSearch()}async showEcosystemExplore(){this.showExplore()}setupExploreSearch(){let e=document.getElementById("explore-search"),t=document.getElementById("search-results");if(!e||!t)return;let s=null;e.addEventListener("input",()=>{clearTimeout(s);let a=e.value.trim();if(a.length<2){t.classList.add("hidden"),t.innerHTML="";return}s=setTimeout(async()=>{let i=await fetch(`/api/search?q=${encodeURIComponent(a)}`);if(!i.ok)return;let n=await i.json();if(!(n.users.length||n.bots.length||n.hashtags.length||n.groups.length)){t.innerHTML='<div class="p-4 text-center text-zinc-500 text-sm">No results found</div>',t.classList.remove("hidden");return}let o="";n.users.length&&(o+=`<div class="px-3 py-2 bg-zinc-800/50 text-xs font-semibold text-zinc-400 uppercase tracking-wide flex items-center gap-2">
            ...
            Groups
          </div>`,n.groups.forEach(r=>{let p=r.ecosystem_name?`<span class="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-400 text-[10px] font-medium border border-emerald-500/20">${this.escapeHtml(r.ecosystem_name)}</span>`:"";o+=`<button class="search-result-group w-full px-3 py-2 flex items-center gap-3 hover:bg-zinc-800 transition-colors text-left" data-id="${r.id}" data-slug="${r.slug}">
              ...
              <div class="flex-1 min-w-0">
                <div class="text-sm font-medium text-zinc-100 truncate flex items-center gap-2">${this.escapeHtml(r.name)} ${p}</div>
                <div class="text-xs text-zinc-500 truncate">${this.escapeHtml(r.description||r.slug)}</div>
              </div>
            </button>`})),t.innerHTML=o,t.classList.remove("hidden"),t.querySelectorAll(".search-result-user").forEach(r=>{r.addEventListener("click",()=>{let p=r.dataset.id,m=r.dataset.name;p&&(t.classList.add("hidden"),e.value="",this.showUserProfile(m||p))})}),t.querySelectorAll(".search-result-tag").forEach(r=>{r.addEventListener("click",()=>{let p=r.dataset.tag;p&&(t.classList.add("hidden"),e.value="",this.showHashtagFeed(p))})}),t.querySelectorAll(".search-result-group").forEach(r=>{r.addEventListener("click",()=>{let p=r.dataset.id;p&&(t.classList.add("hidden"),e.value="",this.openGroup(p))})})},200)}),e.addEventListener("blur",()=>{setTimeout(()=>t.classList.add("hidden"),200)}),e.addEventListener("focus",()=>{e.value.trim().length>=2&&t.innerHTML&&t.classList.remove("hidden")})}async showHashtagFeed(e){let t=await fetch(`/api/hashtags/${e}`,{headers:{"X-Auth-Hash":this.appState.hash||""}}),s=t.ok?await t.json():{tag:e,posts:[],total:0};this.setContent(`
      <div class="max-w-2xl mx-auto px-4 py-8">
          ...
          `:s.posts.map(a=>`
            <div class="post-card">
              <div class="flex items-start gap-4">
                ${a.author?.avatar?`
                  <img src="${a.author.avatar}" alt="${a.author.displayName}" class="w-10 h-10 rounded-full object-cover flex-shrink-0 border border-zinc-700">
                `:`
                  <div class="avatar avatar-md flex-shrink-0">
                    <span>${a.author?.displayName?.charAt(0)||"?"}</span>
                  </div>
                `}
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2 mb-2">
                    <span class="font-semibold text-zinc-100">${a.author?.displayName||"Anonymous"}</span>
                    <span class="text-zinc-600">\xB7</span>
                    <span class="text-sm text-zinc-500">${this.formatTime(a.created_at)}</span>
                  </div>
                  <div class="text-zinc-300 leading-relaxed prose prose-sm prose-invert">${me(a.content)}</div>
                </div>
              </div>
            </div>
          `).join("")}
    ...
    `),document.getElementById("back-to-explore")?.addEventListener("click",()=>this.showExplore())}async showUserProfile(e){let t=await fetch(`/api/users/search/${e}`),a=(t.ok?await t.json():[]).find(l=>l.displayName.toLowerCase()===e.toLowerCase()||l.username&&l.username.toLowerCase()===e.toLowerCase());if(!a){D("User not found","error");return}let i=await fetch(`/api/users/${a.id}`),n=i.ok?await i.json():null;if(!n){D("User not found","error");return}this.setContent(`
      <div class="max-w-2xl mx-auto px-4 py-8">
      ...
      <div class="post-card mx-0 sm:mx-0 rounded-none sm:rounded-xl border-x-0 sm:border-x" data-post-id="${s.id}">
        <div class="flex items-start gap-3 sm:gap-4">
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="text-zinc-300 leading-relaxed text-sm sm:text-base prose prose-sm prose-invert prose-p:my-1 prose-a:text-emerald-400 prose-code:bg-zinc-800 prose-code:px-1 prose-code:rounded break-words">${me(s.content)}</div>
            ${s.image_url?`
    ...
    `).join(""),t.querySelectorAll(".like-btn").forEach(s=>{s.addEventListener("click",a=>{let i=a.currentTarget.dataset.postId;i&&this.likePost(i)})}),t.querySelectorAll(".edit-post-btn").forEach(s=>{s.addEventListener("click",a=>{a.stopPropagation();let i=a.currentTarget,n=i.dataset.postId,l=i.dataset.content||"";n&&this.editPost(n,l)})}),t.querySelectorAll(".delete-post-btn").forEach(s=>{s.addEventListener("click",a=>{a.stopPropagation();let i=a.currentTarget.dataset.postId;i&&this.deletePost(i)})}),t.querySelectorAll(".comment-toggle-btn").forEach(s=>{s.addEventListener("click",async a=>{let i=a.currentTarget.dataset.postId;i&&await this.toggleComments(i)})}),t.querySelectorAll(".send-comment-btn").forEach(s=>{s.addEventListener("click",async a=>{let i=a.currentTarget.dataset.postId;i&&await this.sendComment(i)})}),t.querySelectorAll(".comment-input").forEach(s=>{s.addEventListener("keypress",async a=>{if(a.key==="Enter"){let i=a.currentTarget.dataset.postId;i&&await this.sendComment(i)}})}),t.querySelectorAll(".reaction-btn").forEach(s=>{s.addEventListener("click",a=>{a.stopPropagation();let i=a.currentTarget,n=i.dataset.postId;n&&this.openEmojiDrawer("post",n,i)})}),t.querySelectorAll(".reactions-display[data-post-id]").forEach(s=>{let a=s.dataset.postId;a&&this.loadReactions("post",a)})}}async likePost(e){try{let t=await fetch(`/api/posts/${e}/like`,{method:"POST",headers:{"X-Auth-Hash":this.appState.hash||""}});if(t.ok){let s=await t.json(),a=this.posts.findIndex(n=>n.id===e);a!==-1&&(this.posts[a].liked=s.liked,this.posts[a].likes_count=s.likes_count);let i=document.querySelector(`.like-btn[data-post-id="${e}"]`);if(i){let n=i.querySelector(".like-count");n&&(n.textContent=String(s.likes_count));let l=i.querySelector("svg");l&&l.setAttribute("fill",s.liked?"currentColor":"none"),s.liked?(i.classList.add("text-emerald-500"),i.classList.remove("text-warm-gray-400")):(i.classList.remove("text-emerald-500"),i.classList.add("text-warm-gray-400"))}}}catch(t){console.error("Failed to like post:",t)}}async toggleComments(e){let t=document.querySelector(`.comments-section[data-post-id="${e}"]`);if(!t)return;t.classList.contains("hidden")?(t.classList.remove("hidden"),await this.loadComments(e)):t.classList.add("hidden")}async loadComments(e){let s=document.querySelector(`.comments-section[data-post-id="${e}"]`)?.querySelector(".comments-list");if(s)try{let a=await fetch(`/api/posts/${e}/comments`,{headers:{"X-Auth-Hash":this.appState.hash||""}});if(a.ok){let i=await a.json();i.length===0?s.innerHTML='<p class="text-zinc-500 text-sm italic">No comments yet</p>':(s.innerHTML=i.map(n=>`
          ...
          `).join(""),s.querySelectorAll(".delete-comment-btn").forEach(n=>{n.addEventListener("click",async l=>{let o=l.currentTarget.dataset.commentId;o&&await this.deleteComment(o,e)})}))}}catch(a){console.error("Failed to load comments:",a)}}async sendComment(e){let t=document.querySelector(`.comment-input[data-post-id="${e}"]`);if(!t)return;let s=t.value.trim();if(s)try{if((await fetch(`/api/posts/${e}/comments`,{method:"POST",headers:{"Content-Type":"application/json","X-Auth-Hash":this.appState.hash||""},body:JSON.stringify({content:s})})).ok){t.value="",await this.loadComments(e);let i=document.querySelector(`.comment-toggle-btn[data-post-id="${e}"] .replies-count`);if(i){let n=parseInt(i.textContent||"0",10);i.textContent=String(n+1)}}}catch(a){console.error("Failed to send comment:",a)}}async deleteComment(e,t){try{if((await fetch(`/api/comments/${e}`,{method:"DELETE",headers:{"X-Auth-Hash":this.appState.hash||""}})).ok){await this.loadComments(t);let a=document.querySelector(`.comment-toggle-btn[data-post-id="${t}"] .replies-count`);if(a){let i=parseInt(a.textContent||"0",10);a.textContent=String(Math.max(0,i-1))}}}catch(s){console.error("Failed to delete comment:",s)}}showProfile(){let e=this.appState.user;e&&(this.setActiveNav("nav-profile"),this.setContent(`
      <div class="h-full w-full flex flex-col">
        <div class="panel flex-1">
          <div class="panel-header">
            <div class="flex items-center gap-3">
...
ws.onmessage = (event) => {
  ...
  if (data.type === 'new_post') {
    console.log('New post:', data.post.content);
      ...
      `},i=e||"gs-overview";this.setContent(`
            ...
            ${t.map(o=>`
              <div class="docs-section-group" data-section-id="${o.id}">
                <button class="docs-section-toggle w-full text-left px-4 py-2 flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-zinc-500 hover:text-zinc-300 transition-colors">
                  ...
                  <i data-lucide="chevron-right" class="w-3 h-3 docs-chevron transition-transform ${o.children?.some(r=>r.id===i)?"rotate-90":""}"></i>
                </button>
                <div class="docs-section-children ${o.children?.some(r=>r.id===i)?"":"hidden"}">
                  ${(o.children||[]).map(r=>`
                    <button class="docs-nav-item w-full text-left px-4 pl-10 py-1.5 text-sm transition-colors ${r.id===i?"text-emerald-400 bg-emerald-500/10 border-r-2 border-emerald-500":"text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800/50"}" data-doc-id="${r.id}">
                      ${r.title}
                    </button>
                  `).join("")}
                </div>
          ...
          <select id="docs-mobile-nav" class="input w-full text-sm py-2">
            ${t.map(o=>`
              <optgroup label="${o.title}">
                ${(o.children||[]).map(r=>`
                  <option value="${r.id}" ${r.id===i?"selected":""}>${r.title}</option>
                `).join("")}
              </optgroup>
            `).join("")}
          </select>
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar" id="docs-content-area">
          <div class="max-w-3xl mx-auto p-6 md:p-10">
            <div id="docs-content" class="docs-content">
              ${a[i]||'<p class="text-zinc-400">Select a section from the sidebar.</p>'}
            </div>
          </div>
        </div>
      </div>
    `),window.lucide&&window.lucide.createIcons(),document.querySelectorAll(".docs-section-toggle").forEach(o=>{o.addEventListener("click",()=>{let p=o.closest(".docs-section-group")?.querySelector(".docs-section-children"),m=o.querySelector(".docs-chevron");p&&(p.classList.toggle("hidden"),m?.classList.toggle("rotate-90"))})}),document.querySelectorAll(".docs-nav-item").forEach(o=>{o.addEventListener("click",()=>{let r=o.dataset.docId;r&&a[r]&&this.renderDocSection(r,a,t)})});let n=document.getElementById("docs-mobile-nav");n?.addEventListener("change",()=>{let o=n.value;o&&a[o]&&this.renderDocSection(o,a,t)});let l=document.getElementById("docs-search");l?.addEventListener("input",()=>{let o=l.value.toLowerCase().trim();document.querySelectorAll(".docs-section-group").forEach(r=>{let p=r.querySelectorAll(".docs-nav-item"),m=!1;p.forEach(u=>{let h=u.textContent?.toLowerCase()||"",v=!o||h.includes(o);u.style.display=v?"":"none",v&&(m=!0)});let f=r.querySelector(".docs-section-children"),b=r.querySelector(".docs-chevron");o&&m&&(f?.classList.remove("hidden"),b?.classList.add("rotate-90")),r.style.display=m||!o?"":"none"})})}renderDocSection(e,t,s){let a=document.getElementById("docs-content");a&&t[e]&&(a.innerHTML=t[e],document.getElementById("docs-content-area")?.scrollTo(0,0)),document.querySelectorAll(".docs-nav-item").forEach(n=>{n.dataset.docId===e?(n.classList.add("text-emerald-400","bg-emerald-500/10","border-r-2","border-emerald-500"),n.classList.remove("text-zinc-400","hover:text-zinc-200","hover:bg-zinc-800/50")):(n.classList.remove("text-emerald-400","bg-emerald-500/10","border-r-2","border-emerald-500"),n.classList.add("text-zinc-400","hover:text-zinc-200","hover:bg-zinc-800/50"))});for(let n of s)if(n.children?.some(l=>l.id===e)){let l=document.querySelector(`[data-section-id="${n.id}"]`),o=l?.querySelector(".docs-section-children"),r=l?.querySelector(".docs-chevron");o?.classList.remove("hidden"),r?.classList.add("rotate-90")}let i=document.getElementById("docs-mobile-nav");i&&(i.value=e)}async showGeppetto(){if(this.setActiveNav("nav-geppetto"),!this.appState.user){this.showApp();return}let t=await fetch("/api/my-bots",{headers:{"X-Auth-Hash":this.appState.hash||""}}),s=t.ok?await t.json():[];this.setContent(`
      <div class="h-full w-full flex flex-col">
        <div class="panel flex-1">
          <div class="panel-header">
            <div class="flex items-center gap-3">
                    ...
                    <div class="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700 flex items-center justify-between">
                      <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-600 flex items-center justify-center">
                          <span class="text-white font-bold text-sm">${(a.displayName||"B").charAt(0).toUpperCase()}</span>
                        </div>
                        <div>
                          <p class="text-zinc-100 font-medium">${this.escapeHtml(a.displayName)}</p>
                          <div class="flex items-center gap-2 mt-1">
                            <span class="text-zinc-500 text-xs">@${this.escapeHtml(a.username||a.displayName?.toLowerCase())}</span>
                            <span class="px-1.5 py-0.5 rounded text-[10px] ${a.bot_data?.status==="approved"?"bg-emerald-500/20 text-emerald-400":a.bot_data?.status==="active"?"bg-blue-500/20 text-blue-400":"bg-amber-500/20 text-amber-400"}">${a.bot_data?.status||"pending"}</span>
                          </div>
                        </div>
                      </div>
                      <div class="flex items-center gap-2">
                        ${a.bot_data?.capabilities_granted_global?.length>0?`
                          <div class="flex gap-1">
                            ${a.bot_data.capabilities_granted_global.slice(0,3).map(i=>`
                              <span class="px-1.5 py-0.5 bg-zinc-700 text-zinc-300 rounded text-[10px]">${i}</span>
                            `).join("")}
                          </div>
                        `:""}
                        <span class="text-zinc-500 text-xs">...${a.bot_data?.api_token_suffix||"????"}</span>
                      </div>
                    </div>
                  `).join("")}
                </div>
    ...
    `),document.getElementById("open-geppetto-dm")?.addEventListener("click",()=>this.openGeppettoDM()),document.getElementById("create-first-bot")?.addEventListener("click",()=>this.openGeppettoDM("/newbot")),document.querySelectorAll(".geppetto-cmd").forEach(a=>{a.addEventListener("click",()=>{let i=a.dataset.cmd;i&&this.openGeppettoDM(i)})})}async openGeppettoDM(e){let t="geppetto-system-bot",s=await fetch(`/api/dm/start/${t}`,{method:"POST",headers:{"X-Auth-Hash":this.appState.hash||""}});if(s.ok){let i=(await s.json()).id;this.appState.currentDMConversation=i,e&&await fetch(`/api/dm/${i}/messages`,{method:"POST",headers:{"X-Auth-Hash":this.appState.hash||"","Content-Type":"application/json"},body:JSON.stringify({content:e})}),this.openDMChat(i,t,"Geppetto")}}async showAdmin(){this.setActiveNav("nav-admin");let e=this.appState.user,t=this.activeEcosystem&&this.userEcosystems.find(g=>g.id===this.activeEcosystem?.id&&g.user_role==="admin");if(!e?.is_admin&&!e?.is_superadmin&&!t){this.showApp();return}let s=this.activeEcosystem?.id||this.defaultEcosystemId,a=this.activeEcosystem?.name?.toUpperCase()||"DEVNET",i={"X-Auth-Hash":this.appState.hash||""},[n,l,o,r,p,m,f]=await Promise.all([fetch(`/api/admin/stats?ecosystem_id=${s}`,{headers:i}),fetch(`/api/admin/groups/pending?ecosystem_id=${s}`,{headers:i}),fetch(`/api/admin/activity/summary?ecosystem_id=${s}`,{headers:i}),fetch(`/api/admin/users?ecosystem_id=${s}`,{headers:i}),fetch(`/api/admin/bots/applications?ecosystem_id=${s}`,{headers:i}),fetch(`/api/admin/bots?ecosystem_id=${s}`,{headers:i}),fetch(`/api/ecosystems/${s}`,{headers:i})]),b=n.ok?await n.json():{users:0,posts:0,groups:0,pending_groups:0},u=l.ok?await l.json():[],h=o.ok?await o.json():{total_events:0,action_counts:{},recent:[]},v=r.ok?await r.json():[],y=p.ok?await p.json():[],w=m.ok?await m.json():[],k=f.ok?await f.json():{},S=b.admin_role==="super_admin",L=new Date,se=Math.floor(Math.random()*99999)+1e4;this.setContent(`
      <div class="h-full w-full flex flex-col bg-black overflow-hidden font-mono">
        ...
        <div class="bg-black border-b border-emerald-500/30 px-4 py-2 flex items-center justify-between">
          <div class="flex items-center gap-4">
            <span class="text-emerald-500 text-lg font-bold tracking-wider animate-pulse">\u25B6 ${a} COMMAND CENTER</span>
          ...
          <div class="flex items-center gap-6 text-xs">
            <span class="text-emerald-400/80">SYS_UPTIME: <span class="text-emerald-300">${se}s</span></span>
    ...
    `),document.querySelectorAll(".approve-btn").forEach(g=>{g.addEventListener("click",async T=>{let $=T.currentTarget.dataset.groupId;$&&await this.adminAction($,"approve")})}),document.querySelectorAll(".reject-btn").forEach(g=>{g.addEventListener("click",async T=>{let $=T.currentTarget.dataset.groupId;$&&confirm("Are you sure you want to reject this group?")&&await this.adminAction($,"reject")})}),document.querySelectorAll(".ban-user-btn").forEach(g=>{g.addEventListener("click",async T=>{let $=T.currentTarget.dataset.userId;$&&confirm("Ban this user?")&&await this.userAction($,"ban")})}),document.querySelectorAll(".unban-user-btn").forEach(g=>{g.addEventListener("click",async T=>{let $=T.currentTarget.dataset.userId;$&&await this.userAction($,"unban")})}),document.querySelectorAll(".make-admin-btn").forEach(g=>{g.addEventListener("click",async T=>{let $=T.currentTarget.dataset.userId;$&&confirm("Grant admin privileges to this user?")&&await this.userAction($,"make-admin")})}),document.querySelectorAll(".remove-admin-btn").forEach(g=>{g.addEventListener("click",async T=>{let $=T.currentTarget.dataset.userId;$&&confirm("Remove admin privileges from this user?")&&await this.userAction($,"remove-admin")})}),document.querySelectorAll(".approve-bot-btn").forEach(g=>{g.addEventListener("click",async T=>{let $=T.currentTarget.dataset.botId,F=T.currentTarget.dataset.caps?.split(",").filter(Z=>Z)||[];$&&confirm(`Approve this bot with capabilities: ${F.join(", ")}?`)&&await this.botAction($,"approve",F)})}),document.querySelectorAll(".reject-bot-btn").forEach(g=>{g.addEventListener("click",async T=>{let $=T.currentTarget.dataset.botId;$&&confirm("Reject this bot application?")&&await this.botAction($,"reject")})}),document.querySelectorAll(".revoke-bot-btn").forEach(g=>{g.addEventListener("click",async T=>{let $=T.currentTarget.dataset.botId;$&&confirm("Revoke this bot's capabilities?")&&await this.botAction($,"revoke")})}),document.querySelectorAll(".eco-ban-bot-btn").forEach(g=>{g.addEventListener("click",async T=>{let $=T.currentTarget.dataset.botId;$&&confirm("Block this bot from your ecosystem? It will be unable to post or apply to groups.")&&await this.ecoBotAction($,"eco-ban")})}),document.querySelectorAll(".eco-unban-bot-btn").forEach(g=>{g.addEventListener("click",async T=>{let $=T.currentTarget.dataset.botId;$&&await this.ecoBotAction($,"eco-unban")})});let oe=document.getElementById("eco-accent-color"),Y=document.getElementById("eco-accent-hex");oe&&Y&&(oe.addEventListener("input",()=>{Y.value=oe.value}),Y.addEventListener("input",()=>{/^#[0-9a-fA-F]{6}$/.test(Y.value)&&(oe.value=Y.value)}));let re=document.getElementById("eco-secondary-color"),J=document.getElementById("eco-secondary-hex");re&&J&&(re.addEventListener("input",()=>{J.value=re.value}),J.addEventListener("input",()=>{/^#[0-9a-fA-F]{6}$/.test(J.value)&&(re.value=J.value)}));let z=async g=>{let T=new FormData;T.append("file",g);let $=await fetch("/api/upload/image",{method:"POST",headers:{"X-Auth-Hash":this.appState.hash||""},body:T});return $.ok?(await $.json()).url||null:(C("Image upload failed","error"),null)};document.getElementById("eco-icon-upload")?.addEventListener("change",async g=>{let T=g.target.files?.[0];if(!T)return;C("Uploading logo...","info");let $=await z(T);$&&await this.saveEcoSettings(s,{icon:$})}),document.getElementById("eco-banner-upload")?.addEventListener("change",async g=>{let T=g.target.files?.[0];if(!T)return;C("Uploading banner...","info");let $=await z(T);$&&await this.saveEcoSettings(s,{banner:$})}),document.getElementById("eco-settings-save")?.addEventListener("click",async()=>{let g={},T=document.getElementById("eco-name"),$=document.getElementById("eco-tagline"),F=document.getElementById("eco-description"),Z=document.getElementById("eco-website"),ue=document.getElementById("eco-theme"),Le=document.getElementById("eco-invite-only"),Oe=document.getElementById("eco-visibility");T&&(g.name=T.value),$&&(g.tagline=$.value),F&&(g.description=F.value),Z&&(g.website=Z.value),Y&&(g.accent_color=Y.value),J&&(g.secondary_color=J.value),ue&&(g.theme=ue.value),Oe&&(g.visibility=Oe.value),Le&&(g.invite_only=Le.checked),await this.saveEcoSettings(s,g)})}async botAction(e,t,s){let a=JSON.stringify(t==="approve"?{capabilities:s}:{reason:"Admin action"});if((await fetch(`/api/admin/bots/${e}/${t}`,{method:"POST",headers:{"X-Auth-Hash":this.appState.hash||"","Content-Type":"application/json"},body:a})).ok){let n=document.querySelector(`[data-bot-app-id="${e}"]`);n&&(n.style.transition="all 0.3s ease",n.style.opacity="0.3",n.style.transform="translateX(20px)"),C(`Bot ${t==="approve"?"approved":t==="reject"?"rejected":"revoked"} successfully`,t==="approve"?"success":"info"),setTimeout(()=>this.showAdmin(),600)}else C(`Failed to ${t} bot`,"error")}async ecoBotAction(e,t){let s=this.activeEcosystem?.id||this.defaultEcosystemId;(await fetch(`/api/admin/bots/${e}/${t}?ecosystem_id=${s}`,{method:"POST",headers:{"X-Auth-Hash":this.appState.hash||"","Content-Type":"application/json"}})).ok?(C(`Bot ${t==="eco-ban"?"blocked from ecosystem":"unblocked in ecosystem"}`,t==="eco-ban"?"info":"success"),setTimeout(()=>this.showAdmin(),600)):C(`Failed to ${t} bot`,"error")}async saveEcoSettings(e,t){let s=await fetch(`/api/ecosystems/${e}`,{method:"PATCH",headers:{"X-Auth-Hash":this.appState.hash||"","Content-Type":"application/json"},body:JSON.stringify(t)});if(s.ok){let a=await s.json();this.activeEcosystem&&this.activeEcosystem.id===e&&(this.activeEcosystem={...this.activeEcosystem,...a},this.applyEcosystemColors(this.activeEcosystem));let i=this.userEcosystems.findIndex(n=>n.id===e);i>=0&&(this.userEcosystems[i]={...this.userEcosystems[i],...a}),C("Ecosystem settings saved","success"),setTimeout(()=>this.showAdmin(),400)}else{let a=await s.json().catch(()=>({}));C(a.detail||"Failed to save settings","error")}}async userAction(e,t){let s=this.activeEcosystem?.id||this.defaultEcosystemId;if(!(await fetch(`/api/admin/users/${e}/${t}?ecosystem_id=${s}`,{method:"POST",headers:{"X-Auth-Hash":this.appState.hash||""}})).ok){C(`Failed to ${t.replace("-"," ")} user`,"error");return}let i=document.querySelector(`tr[data-user-id="${e}"]`);i&&(i.style.transition="all 0.3s ease",i.style.background="rgba(16,185,129,0.1)"),C(`User ${{ban:"banned",unban:"unbanned","make-admin":"promoted to admin","remove-admin":"demoted"}[t]||t} successfully`,"success"),setTimeout(()=>this.showAdmin(),600)}async adminAction(e,t){if((await fetch(`/api/admin/groups/${e}/${t}`,{method:"POST",headers:{"X-Auth-Hash":this.appState.hash||""}})).ok){let a=document.querySelector(`[data-group-id="${e}"]`);a&&(a.style.transition="all 0.3s ease",a.style.opacity="0.3",a.style.transform="translateX(20px)"),C(`Group ${t==="approve"?"approved":"rejected"} successfully`,t==="approve"?"success":"info"),setTimeout(()=>this.showAdmin(),600)}else C(`Failed to ${t} group`,"error")}currentGroup=null;groupSocket=null;groupMessages=[];currentGroupId=null;replyingTo=null;viewingThreadId=null;isOpeningGroup=!1;hasMoreMessages=!1;nextBefore=null;isLoadingMore=!1;scrollObserver=null;async showGroups(){this.setActiveNav("nav-groups");let e=await fetch(`/api/groups?ecosystem_id=${this.activeEcosystem?.id||this.defaultEcosystemId}`,{headers:{"X-Auth-Hash":this.appState.hash||""}}),t=e.ok?await e.json():[];this.setContent(`
      <div class="h-full w-full flex flex-col">
        <div class="panel flex-1">
          <div class="panel-header">
            <div class="flex items-center gap-3">
...
Do you agree?`))return;let a=document.querySelector(`.join-group-btn[data-group-id="${e}"]`);a&&(a.innerHTML='<span class="flex items-center justify-center gap-1.5"><svg class="w-4 h-4 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>Joining...</span>',a.classList.add("pointer-events-none","opacity-70"));let i=await fetch(`/api/groups/${e}/join`,{method:"POST",headers:{"Content-Type":"application/json","X-Auth-Hash":this.appState.hash||""},body:JSON.stringify({agreed_to_terms:!0})});if(i.ok)C(`Joined "${s.name}" successfully!`,"success"),this.showGroups();else{let n=await i.json().catch(()=>({detail:"Failed to join"}));C(n.detail||"Failed to join group","error"),a&&(a.innerHTML='<span class="flex items-center justify-center gap-1.5"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/></svg>Join</span>',a.classList.remove("pointer-events-none","opacity-70"))}}async openGroup(e,t=!1){if(!this.isOpeningGroup){this.isOpeningGroup=!0,this.currentGroupId=e;try{let[s,a]=await Promise.all([fetch(`/api/groups/${e}`,{headers:{"X-Auth-Hash":this.appState.hash||""}}),fetch("/api/groups",{headers:{"X-Auth-Hash":this.appState.hash||""}})]);if(!s.ok)return;let i=await s.json(),n=a.ok?await a.json():[],l=Array.isArray(n)?n:[];if(!t&&!i.is_member){await this.joinGroup(e);return}this.currentGroup=i;let[o,r]=await Promise.all([fetch(`/api/groups/${e}/messages`,{headers:{"X-Auth-Hash":this.appState.hash||""}}),fetch(`/api/groups/${e}/members`,{headers:{"X-Auth-Hash":this.appState.hash||""}})]),p=o.ok?await o.json():{messages:[],has_more:!1,next_before:null};p&&p.messages?(this.groupMessages=Array.isArray(p.messages)?p.messages:[],this.hasMoreMessages=p.has_more||!1,this.nextBefore=p.next_before??null):(this.groupMessages=Array.isArray(p)?p:[],this.hasMoreMessages=!1,this.nextBefore=null);let m=r.ok?await r.json():{members:[]},f=Array.isArray(m.members)?m.members:Array.isArray(m)?m:[];this.setActiveNav("nav-groups"),this.setContent(`
      <div class="h-full w-full flex flex-col md:flex-row bg-zinc-950" style="max-height: 100%; overflow: hidden;">
        <!-- MOBILE TABS -->
        ...
        <div id="panel-chat" class="flex md:flex flex-1 flex-col min-w-0" style="min-height: 0; overflow: hidden;">
          ...
          <div class="group-header-epic relative overflow-hidden border-b border-zinc-800 flex-shrink-0">
            ...
            ${i.avatar?`<div class="absolute inset-0 opacity-10 blur-2xl" style="background-image: url('${i.avatar}'); background-size: cover; background-position: center;"></div>`:""}
            
            <div class="relative px-4 py-3 flex items-center justify-between">
              <div class="flex items-center gap-3">
                <div class="relative">
                  ${i.avatar?`
                    <img src="${i.avatar}" alt="${i.name}" class="w-10 h-10 rounded-xl object-cover border border-emerald-500/50">
                  `:`
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500/20 to-emerald-500/20 flex items-center justify-center border border-emerald-500/30">
                      <span class="text-lg font-bold text-emerald-400">${i.name.charAt(0).toUpperCase()}</span>
                    </div>
                  `}
                </div>
                <div>
                  <h2 class="font-bold text-zinc-100 flex items-center gap-1.5">${i.privacy==="private"?'<i data-lucide="lock" class="w-4 h-4 text-amber-400"></i>':""}${this.escapeHtml(i.name)}</h2>
                  <p class="text-xs text-zinc-500">${i.privacy==="private"?'<span class="text-amber-400">Private</span> \u2022 ':"/g/"+i.slug+" \u2022 "}${f.length} members</p>
                </div>
              </div>
              
              <div class="flex items-center gap-1">
                ${i.user_role==="owner"||i.user_role==="admin"||this.appState.user?.is_admin?`
                ...
                `:""}
                ${i.creator_id!==this.appState.user?.id?`
                  <button id="leave-group-btn" class="text-zinc-400 hover:text-emerald-400 transition-colors p-2 rounded-lg hover:bg-emerald-500/10" title="Leave Group" data-group-id="${i.id}">
        ...
        <div id="panel-members" class="hidden md:flex w-full md:w-64 flex-shrink-0 border-l border-zinc-800 flex-col bg-zinc-900/50">
          ${(()=>{let u=f.filter(w=>!w.is_bot),h=f.filter(w=>w.is_bot),v=w=>`
            ...
            `,y=window.location.origin+"/g/"+encodeURIComponent(i.slug);return`
              ...
              <div class="p-3 border-b border-zinc-800">
                ...
                <p class="text-[10px] text-zinc-600 mt-1.5">${i.privacy==="private"?"\u{1F512} Private \u2014 only share with trusted people":"Anyone with this link can join"}</p>
              </div>
        ...
        <div id="group-settings-modal" class="fixed inset-0 bg-black/80 backdrop-blur-sm hidden items-center justify-center z-50">
          <div class="card max-w-lg w-full mx-4 slide-up max-h-[90vh] overflow-y-auto">
            ...
            <form id="group-settings-form" class="space-y-4">
              <div class="flex justify-center">
                <div class="relative">
                  <div id="edit-group-avatar-preview" style="width: 80px; height: 80px; border-radius: 16px; background: linear-gradient(135deg, #3f3f46, #27272a); display: flex; align-items: center; justify-content: center; cursor: pointer; border: 2px solid #10b981; transition: all 0.2s; overflow: hidden;">
                    ${i.avatar?`<img src="${i.avatar}" style="width: 100%; height: 100%; object-fit: cover;">`:`<span class="text-2xl font-bold text-emerald-400">${i.name.charAt(0).toUpperCase()}</span>`}
                  </div>
              ...
              <input type="hidden" name="avatar" id="edit-group-avatar-url" value="${i.avatar||""}">
              <div>
                <label class="block text-sm font-medium text-zinc-300 mb-2">Name</label>
                <input type="text" name="name" class="input" value="${this.escapeHtml(i.name)}" required />
              </div>
              <div>
                <label class="block text-sm font-medium text-zinc-300 mb-2">Description</label>
                <textarea name="description" class="input resize-none" rows="3">${this.escapeHtml(i.description||"")}</textarea>
              </div>
              <div>
                <label class="block text-sm font-medium text-zinc-300 mb-2">Terms</label>
                <textarea name="terms" class="input resize-none" rows="2">${this.escapeHtml(i.terms||"")}</textarea>
              </div>
              <div class="flex gap-3 pt-2">
            ...
            ${i.privacy==="private"&&i.user_role==="owner"?`
    ...
    `:"")+this.groupMessages.map(t=>{let s=t.user_id===this.appState.user?.id,a=this.formatTimeLocal(t.created_at||t.timestamp),i=s?this.appState.user?.displayName||"You":t.author?.displayName||"Unknown",n=(t.content||"").substring(0,80),l=this.escapeHtml(t.id||""),o=this.escapeHtml(t.user_id||""),r=this.escapeHtml(i),p=this.escapeHtml(n),m=t.reply_to?(()=>{let f=this.escapeHtml(t.reply_to.author_name||"Unknown"),b=this.escapeHtml((t.reply_to.content_preview||"").substring(0,60));return`
          ...
          <div class="chat-msg-wrapper" data-msg-id="${l}" data-reply-user-id="${o}" data-reply-sender="${r}" data-reply-preview="${p}" style="display: flex; justify-content: flex-end; padding: 2px 0;" title="Double-click to reply">
            <div style="max-width: 70%; position: relative; cursor: default;">
              ...
              <div class="chat-bubble-reply" style="background: rgba(255, 255, 255, 0.95); color: #0f0f0f; padding: 10px 14px; border-radius: 18px 18px 4px 18px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); border: 1px solid rgba(255,255,255,0.3); transition: all 0.15s; position: relative;">
                ${t.content?`<div style="font-size: 14px; line-height: 1.45; word-wrap: break-word; font-weight: 500;">${me(t.content)}</div>`:""}
              ...
              `:""}
              <div style="font-size: 10px; color: #71717a; text-align: right; margin-top: 3px; padding-right: 4px;">${a}</div>
            </div>
          </div>
        `;{let f=t.author?.displayName?.charAt(0).toUpperCase()||"?",b=["#f97316","#a855f7","#ec4899","#14b8a6","#facc15","#10b981","#3b82f6","#8b5cf6"],u=t.author?.displayName?.charCodeAt(0)%b.length||0,h=b[u];return`
          <div class="chat-msg-wrapper" data-msg-id="${l}" data-reply-user-id="${o}" data-reply-sender="${r}" data-reply-preview="${p}" style="display: flex; align-items: flex-end; gap: 8px; padding: 2px 0;" title="Double-click to reply">
            ${t.author?.avatar?`
            ...
            <div style="max-width: 70%; cursor: default;">
              ...
              <div class="chat-bubble-reply" style="background: linear-gradient(135deg, #2a2a2e, #1f1f23); color: #fafafa; padding: 10px 14px; border-radius: 18px 18px 18px 4px; border: 1px solid #404045; box-shadow: 0 2px 6px rgba(0,0,0,0.25); transition: all 0.15s; position: relative;">
                ${t.content?`<div style="font-size: 14px; line-height: 1.45; word-wrap: break-word;">${me(t.content)}</div>`:""}
                ${t.image_url?`<img src="${this.escapeHtml(t.image_url)}" alt="Shared" class="chat-img-open" style="max-width: 100%; max-height: 200px; border-radius: 10px; margin-top: 8px; cursor: pointer; display: block;">`:""}
              ...
              `:""}
              <div style="font-size: 10px; color: #71717a; margin-top: 3px; margin-left: 2px;">${a}</div>
            </div>
          </div>
        `}}).join("")}renderGroupMessage(e){let t=e.user_id===this.appState.user?.id,s=this.formatTimeLocal(e.created_at||e.timestamp),a=t?this.appState.user?.displayName||"You":e.author?.displayName||"Unknown",i=(e.content||"").substring(0,80),n=this.escapeHtml(e.id||""),l=this.escapeHtml(e.user_id||""),o=this.escapeHtml(a),r=this.escapeHtml(i),p=e.reply_to?(()=>{let m=this.escapeHtml(e.reply_to.author_name||"Unknown"),f=this.escapeHtml((e.reply_to.content_preview||"").substring(0,60));return`
        ...
        <div class="chat-msg-wrapper" data-msg-id="${n}" data-reply-user-id="${l}" data-reply-sender="${o}" data-reply-preview="${r}" style="display: flex; justify-content: flex-end; padding: 2px 0;" title="Double-click to reply">
          <div style="max-width: 70%; position: relative; cursor: default;">
            ${p}
            <div class="chat-bubble-reply" style="background: rgba(255, 255, 255, 0.95); color: #0f0f0f; padding: 10px 14px; border-radius: 18px 18px 4px 18px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); border: 1px solid rgba(255,255,255,0.3); transition: all 0.15s; position: relative;">
              ${e.content?`<div style="font-size: 14px; line-height: 1.45; word-wrap: break-word; font-weight: 500;">${me(e.content)}</div>`:""}
      ...
      `;{let m=e.author?.displayName?.charAt(0).toUpperCase()||"?",f=["#f97316","#a855f7","#ec4899","#14b8a6","#facc15","#10b981","#3b82f6","#8b5cf6"],b=e.author?.displayName?.charCodeAt(0)%f.length||0,u=f[b];return`
        <div class="chat-msg-wrapper" data-msg-id="${n}" data-reply-user-id="${l}" data-reply-sender="${o}" data-reply-preview="${r}" style="display: flex; align-items: flex-end; gap: 8px; padding: 2px 0;" title="Double-click to reply">
          ...
          <div style="max-width: 70%; cursor: default;">
            ...
            ${p}
            <div class="chat-bubble-reply" style="background: linear-gradient(135deg, #2a2a2e, #1f1f23); color: #fafafa; padding: 10px 14px; border-radius: 18px 18px 18px 4px; border: 1px solid #404045; box-shadow: 0 2px 6px rgba(0,0,0,0.25); transition: all 0.15s; position: relative;">
              ${e.content?`<div style="font-size: 14px; line-height: 1.45; word-wrap: break-word;">${me(e.content)}</div>`:""}
              ${e.image_url?`<img src="${this.escapeHtml(e.image_url)}" alt="Shared" class="chat-img-open" style="max-width: 100%; max-height: 200px; border-radius: 10px; margin-top: 8px; cursor: pointer; display: block;">`:""}
      ...
      `}}async loadThreadsList(){if(!this.currentGroupId)return;let e=document.getElementById("threads-list"),t=document.getElementById("left-tab-content-threads");if(!(!e&&!t))try{let s=await fetch(`/api/groups/${this.currentGroupId}/threads`,{headers:{"X-Auth-Hash":this.appState.hash||""}});if(!s.ok)return;let a=await s.json(),n=`
        <div class="flex items-center justify-center h-32 text-zinc-500 text-sm">
          <div class="text-center">
            <i data-lucide="git-branch" class="w-8 h-8 mx-auto mb-2 opacity-50"></i>
            <p>No threads yet</p>
      ...
      `;a.length&&(n=a.map(o=>{let r=this.formatTimeAgo(o.last_reply_at||o.created_at);return`
          ...
          `}).join("")),[e,t].filter(Boolean).forEach(o=>{o.innerHTML=n}),window.lucide&&window.lucide.createIcons(),document.querySelectorAll(".thread-item").forEach(o=>{o.addEventListener("click",r=>{let p=r.currentTarget.dataset.threadId;p&&this.openThreadView(p)})})}catch(s){console.error("Failed to load threads:",s)}}async openThreadView(e){if(this.currentGroupId){this.viewingThreadId=e;try{let t=await fetch(`/api/groups/${this.currentGroupId}/threads/${e}`,{headers:{"X-Auth-Hash":this.appState.hash||""}});if(!t.ok){this.viewingThreadId=null;return}let s=await t.json(),a=document.getElementById("panel-chat"),i=document.getElementById("panel-threads"),n=document.getElementById("panel-groups"),l=document.getElementById("panel-members");[i,n,l].forEach(u=>{u?.classList.add("hidden"),u?.classList.remove("flex")}),a?.classList.remove("hidden"),a?.classList.add("flex"),document.querySelectorAll(".mobile-tab").forEach(u=>{u.classList.remove("text-emerald-400","border-emerald-500"),u.classList.add("text-zinc-400","border-transparent")});let o=document.getElementById("messages-container");if(!o)return;let r=a?.querySelector(".group-header-epic");r&&(r.innerHTML=`
        ...
        `);let p="";[s.root,...s.replies||[]].forEach((u,h)=>{if(!u)return;let v=h===0;p+=this.renderGroupMessage(u),v&&(s.replies||[]).length>0&&(p+=`
          ...
          `)}),o.innerHTML=p,window.lucide&&window.lucide.createIcons(),o.scrollTop=o.scrollHeight;let f=a?.querySelector('input[name="content"]');f&&(f.placeholder="Reply to thread..."),this.replyingTo={messageId:e,userId:s.root?.user_id||"",displayName:s.root?.author?.displayName||"Unknown",content:(s.root?.content||"").substring(0,80)};let b=document.getElementById("reply-preview");b&&b.classList.add("hidden"),document.getElementById("back-from-thread")?.addEventListener("click",()=>{this.exitThreadView()}),this.setupThreadMessageHandlers(o),this.attachMsgReactionListeners()}catch(t){console.error("Failed to open thread:",t),this.viewingThreadId=null}}}exitThreadView(){this.viewingThreadId=null,this.replyingTo=null,this.currentGroupId&&this.openGroup(this.currentGroupId,!0)}setupThreadMessageHandlers(e){e.querySelectorAll(".chat-msg-wrapper").forEach(t=>{t.addEventListener("dblclick",s=>{let a=s.currentTarget,i=a.dataset.msgId||"",n=a.dataset.replyUserId||"",l=a.dataset.replySender||"",o=a.dataset.replyPreview||"";i&&window.__replyToMessage&&window.__replyToMessage(i,n,l,o)})}),e.querySelectorAll(".reply-peek-bar").forEach(t=>{t.addEventListener("click",s=>{let i=s.currentTarget.dataset.scrollTo;i&&window.__scrollToMessage&&window.__scrollToMessage(i)})})}formatTimeAgo(e){try{let t=new Date(e),a=Math.floor((new Date().getTime()-t.getTime())/1e3);return a<60?"just now":a<3600?`${Math.floor(a/60)}m ago`:a<86400?`${Math.floor(a/3600)}h ago`:a<604800?`${Math.floor(a/86400)}d ago`:t.toLocaleDateString()}catch{return""}}pendingChatImageUrl=null;emojiDrawer={visible:!1,targetType:"post",targetId:"",pack:"twemoji",category:"",search:"",page:0,emoji:[],loading:!1,hasMore:!0,element:null};async handleChatImageSelect(e){let t=document.getElementById("chat-upload-error"),s=document.getElementById("chat-image-preview"),a=document.getElementById("chat-preview-img");if(!["image/jpeg","image/png","image/gif","image/webp"].includes(e.type)){t&&(t.textContent="Invalid file type. Use JPEG, PNG, GIF, or WebP.",t.classList.remove("hidden"));return}if(e.size>5*1024*1024){t&&(t.textContent="File too large. Maximum 5MB.",t.classList.remove("hidden"));return}t?.classList.add("hidden");let n=new FileReader;n.onload=l=>{a&&s&&(a.src=l.target?.result,s.classList.remove("hidden"))},n.readAsDataURL(e);try{let l=new FormData;l.append("file",e);let o=await fetch("/api/upload/image",{method:"POST",headers:{"X-Auth-Hash":this.appState.hash||""},body:l});if(o.ok){let r=await o.json();this.pendingChatImageUrl=r.url}else{let r=await o.json();throw new Error(r.detail||"Upload failed")}}catch(l){t&&(t.textContent=l.message||"Failed to upload image",t.classList.remove("hidden")),this.clearChatImagePreview()}}clearChatImagePreview(){this.pendingChatImageUrl=null,document.getElementById("chat-image-preview")?.classList.add("hidden");let e=document.getElementById("chat-image-input");e&&(e.value=""),document.getElementById("chat-upload-error")?.classList.add("hidden")}async sendMessage(){let t=document.getElementById("send-message-form").querySelector('input[name="content"]'),s=t.value.trim();if(!s&&!this.pendingChatImageUrl||!this.currentGroup)return;let a=null;if(this.replyingTo&&(a={message_id:this.replyingTo.messageId,author_name:this.replyingTo.displayName,content_preview:this.replyingTo.content},s&&!this.viewingThreadId)){let l=`@${this.replyingTo.displayName}`;s.toLowerCase().startsWith(l.toLowerCase())||(s=`${l} ${s}`)}if(this.viewingThreadId){let l={messageId:this.viewingThreadId,userId:this.replyingTo?.userId||"",displayName:this.replyingTo?.displayName||"Unknown",content:this.replyingTo?.content||""};this.replyingTo=null,document.getElementById("reply-preview")?.classList.add("hidden"),this.replyingTo=l}else this.replyingTo=null,document.getElementById("reply-preview")?.classList.add("hidden");t.value="";let i=this.pendingChatImageUrl;this.clearChatImagePreview();let n=await fetch(`/api/groups/${this.currentGroup.id}/messages`,{method:"POST",headers:{"Content-Type":"application/json","X-Auth-Hash":this.appState.hash||""},body:JSON.stringify({content:s,image_url:i,reply_to:a})});n.ok||console.error("Failed to send message:",n.status)}connectGroupSocket(e){this.disconnectGroupSocket();let s=`${window.location.protocol==="https:"?"wss:":"ws:"}//${window.location.host}/ws/group/${e}`;this.groupSocket=new WebSocket(s),this.groupSocket.onmessage=a=>{try{let i=JSON.parse(a.data);if(i.type==="new_message"){if(i.message?.thread_root_id&&this.viewingThreadId===i.message.thread_root_id){let n=document.getElementById("messages-container");if(n){let l=this.renderGroupMessage(i.message);n.insertAdjacentHTML("beforeend",l),window.lucide&&window.lucide.createIcons(),this.attachMsgReactionListeners(),n.scrollTop=n.scrollHeight}}else{this.groupMessages.push(i.message);let n=document.getElementById("messages-container");n&&(n.innerHTML=this.renderMessages(),this.attachMsgReactionListeners(),this.scrollToBottom())}if(i.message?.thread_root_id){let n=document.getElementById("panel-threads");n&&!n.classList.contains("hidden")&&this.loadThreadsList()}}else if(i.type==="reaction_update"&&i.target_type==="message"){let n=document.querySelector(`.msg-reactions-display[data-msg-id="${i.target_id}"]`);n&&this.renderReactionBadges(n,i.reactions,"message",i.target_id,i.group_id)}}catch(i){console.error("Failed to parse WebSocket message:",i)}}}disconnectGroupSocket(){this.groupSocket&&(this.groupSocket.close(),this.groupSocket=null),this.scrollObserver&&(this.scrollObserver.disconnect(),this.scrollObserver=null),this.isLoadingMore=!1}setupScrollPagination(e){this.scrollObserver&&(this.scrollObserver.disconnect(),this.scrollObserver=null),this.observeLoadMoreTrigger(e);let t=document.getElementById("load-more-trigger");t&&(t.style.cursor="pointer",t.addEventListener("click",()=>this.loadMoreMessages(e)))}observeLoadMoreTrigger(e){let t=document.getElementById("messages-container"),s=document.getElementById("load-more-trigger");!t||!s||(this.scrollObserver=new IntersectionObserver(a=>{for(let i of a)i.isIntersecting&&this.hasMoreMessages&&!this.isLoadingMore&&this.loadMoreMessages(e)},{root:t,threshold:.1}),this.scrollObserver.observe(s))}async loadMoreMessages(e){if(this.isLoadingMore||!this.hasMoreMessages||this.nextBefore===null)return;this.isLoadingMore=!0;let t=document.getElementById("load-more-spinner"),s=t?.parentElement?.querySelector("span");t&&(t.style.display="block"),s&&(s.textContent="Loading older messages...");try{let a=await fetch(`/api/groups/${e}/messages?before=${this.nextBefore}&limit=50`,{headers:{"X-Auth-Hash":this.appState.hash||""}});if(!a.ok)return;let i=await a.json(),n=Array.isArray(i.messages)?i.messages:[];if(this.hasMoreMessages=i.has_more||!1,this.nextBefore=i.next_before??null,n.length>0){let l=document.getElementById("messages-container");if(!l)return;let o=l.scrollHeight,r=l.scrollTop;this.groupMessages=[...n,...this.groupMessages],this.scrollObserver&&(this.scrollObserver.disconnect(),this.scrollObserver=null),l.innerHTML=this.renderMessages(),this.attachMsgReactionListeners();let p=l.scrollHeight;l.scrollTop=r+(p-o),this.hasMoreMessages&&this.observeLoadMoreTrigger(e)}}catch(a){console.error("Failed to load more messages:",a)}finally{this.isLoadingMore=!1;let a=document.getElementById("load-more-spinner");a&&(a.style.display="none")}}scrollToBottom(){let e=document.getElementById("messages-container");e&&(e.scrollTop=e.scrollHeight)}forceScrollBottom(e){let t=document.getElementById("messages-container");if(!t)return;let s=()=>{t.scrollTop=t.scrollHeight};s(),requestAnimationFrame(()=>{s(),requestAnimationFrame(()=>{s(),setTimeout(()=>{s(),e&&e()},200)})})}getFieldLabelFromUser(e){return{founder:"Founder",developer:"Developer",designer:"Designer",marketer:"Growth",product:"Product",freelancer:"Freelancer",software:"Developer",design:"Designer",marketing:"Marketer",data:"Data",devops:"DevOps",development:"Developer",other:"Builder"}[e.field]||e.field}async showMembersPanel(e,t="members"){let s=await fetch(`/api/groups/${e}/members`,{headers:{"X-Auth-Hash":this.appState.hash||""}});if(!s.ok){D("Failed to load members","error");return}let a=await s.json(),{members:i,my_role:n,is_superadmin:l}=a,o=l||a.is_admin||this.appState.user?.is_admin,r=n==="owner"||o,p=["owner","admin"].includes(n)||o,m=["owner","admin","moderator"].includes(n)||o,f=n==="owner"||o,b=[],u=[];if(f){let y=await fetch(`/api/groups/${e}/bot-applications`,{headers:{"X-Auth-Hash":this.appState.hash||""}});y.ok&&(b=await y.json());let w=await fetch(`/api/groups/${e}/approved-bots`,{headers:{"X-Auth-Hash":this.appState.hash||""}});w.ok&&(u=await w.json())}let h={owner:"bg-yellow-500/20 text-yellow-400 border-yellow-500/30",admin:"bg-emerald-500/20 text-emerald-400 border-emerald-500/30",moderator:"bg-blue-500/20 text-blue-400 border-blue-500/30",member:"bg-zinc-700/50 text-zinc-400 border-zinc-600/30"},v=document.createElement("div");v.className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4",v.id="members-modal",v.innerHTML=`
      <div class="bg-zinc-900 rounded-2xl border border-zinc-700 max-w-lg w-full max-h-[80vh] flex flex-col">
        ...
        <div id="tab-members" class="flex-1 overflow-y-auto p-4 space-y-2 ${t!=="members"?"hidden":""}">
          ${(()=>{let y=i.filter(L=>!L.is_bot),w=i.filter(L=>L.is_bot),k=L=>`
    ...
    `}gifDrawerCleanup=null;async openGifDrawer(e,t,s){let a=document.getElementById("gif-drawer-popup");if(a){a.remove(),this.gifDrawerCleanup&&(this.gifDrawerCleanup(),this.gifDrawerCleanup=null);return}let i=document.createElement("div");i.id="gif-drawer-popup",i.style.cssText=`
    ...
    `,document.body.appendChild(i);let o=t.getBoundingClientRect().left;o+460>window.innerWidth&&(o=window.innerWidth-468),o<8&&(o=8),i.style.left=o+"px";let r=document.getElementById("gif-grid"),p=document.getElementById("gif-search-input"),m=null,f=[],b=0,u="",h=1,v=!1,y=!0,w=8,k=(z,g=!1)=>{g||(r.innerHTML=""),z.forEach(T=>{let $=document.createElement("div");$.className="gif-item",$.title=this.escapeHtml(T.title||"");let F=document.createElement("img");F.src=T.preview_url||T.url,F.alt=this.escapeHtml(T.title||"GIF"),F.loading="lazy",$.appendChild(F),$.addEventListener("click",()=>{this.handleGifSelect(e,T.url,s),Y()}),r.appendChild($)})},S=()=>{if(v)return;let z=f.slice(b,b+w);z.length>0&&(k(z,!0),b+=z.length),b>=f.length&&y&&(v=!0,h++,L(u,h,!0))},L=async(z,g,T=!1)=>{T||(r.innerHTML='<div class="gif-loading" style="grid-column: 1/-1;">Searching...</div>');try{let $=new URLSearchParams({q:z,page:String(g)}),F=await fetch(`/api/gifs?${$.toString()}`,{headers:{"X-Auth-Hash":this.appState.hash||""}});if(!F.ok)throw new Error("Failed");let Z=await F.json();if(!Z.length&&!T){r.innerHTML='<div class="gif-loading" style="grid-column: 1/-1;">No GIFs found</div>',y=!1;return}if(Z.length===0){y=!1,v=!1;return}T?f=f.concat(Z):(f=Z,b=0),y=Z.length>=10,v=!1;let ue=f.slice(b,b+w);k(ue,T),b+=ue.length}catch{T||(r.innerHTML='<div class="gif-loading" style="grid-column: 1/-1;">Failed to load GIFs</div>'),v=!1}},se=document.getElementById("gif-scroll-wrap");se.addEventListener("scroll",()=>{se.scrollTop+se.clientHeight>=se.scrollHeight-50&&S()});let oe=z=>{u=z,h=1,f=[],b=0,y=!0,v=!1,L(z,1,!1)};p.addEventListener("input",()=>{m&&clearTimeout(m),m=setTimeout(()=>oe(p.value.trim()),300)});let Y=()=>{let z=document.getElementById("gif-drawer-popup");z&&z.remove(),this.gifDrawerCleanup&&(this.gifDrawerCleanup(),this.gifDrawerCleanup=null)};document.getElementById("gif-close-btn").addEventListener("click",z=>{z.stopPropagation(),Y()});let re=z=>{!i.contains(z.target)&&z.target!==t&&Y()},J=z=>{z.key==="Escape"&&Y()};setTimeout(()=>document.addEventListener("click",re),10),document.addEventListener("keydown",J),this.gifDrawerCleanup=()=>{document.removeEventListener("click",re),document.removeEventListener("keydown",J),m&&clearTimeout(m)},oe(""),p.focus()}handleGifSelect(e,t,s){if(e==="post"){this.pendingImageUrl=t;let a=document.getElementById("image-preview"),i=document.getElementById("image-preview-container");a&&i&&(a.src=t,i.classList.remove("hidden"))}else if(e==="group"){this.pendingChatImageUrl=t;let a=document.getElementById("chat-preview-img"),i=document.getElementById("chat-image-preview");a&&i&&(a.src=t,i.classList.remove("hidden"))}else if(e==="dm"){s?.setPendingImage&&s.setPendingImage(t);let a=document.getElementById("dm-image-preview-img"),i=document.getElementById("dm-image-preview");a&&i&&(a.src=t,i.classList.remove("hidden"))}}async loadUserEcosystems(){let e=await fetch("/api/ecosystems",{headers:{"X-Auth-Hash":this.appState.hash||""}});this.userEcosystems=e.ok?await e.json():[],this.userEcosystems.length>0&&!this.activeEcosystem&&(this.activeEcosystem=this.userEcosystems[0]),this.activeEcosystem&&this.applyEcosystemColors(this.activeEcosystem),this.renderEcosystemSwitcher(),this.updateAdminNavVisibility()}updateAdminNavVisibility(){let e=this.appState.user;if(!e)return;let t=document.getElementById("nav-admin");if(!t)return;let s=e.is_admin||e.is_superadmin,a=this.activeEcosystem&&this.userEcosystems.find(i=>i.id===this.activeEcosystem?.id&&i.user_role==="admin");s||a?t.classList.remove("hidden"):t.classList.add("hidden")}renderEcosystemSwitcher(){let e=document.getElementById("ecosystem-list"),t=document.getElementById("ecosystem-switcher");!e||!t||(t.classList.remove("hidden"),e.innerHTML=this.userEcosystems.map(s=>`
    ...
    `).join(""),e.querySelectorAll(".eco-switch-btn").forEach(s=>{s.addEventListener("click",()=>{let a=s.dataset.ecoId,i=this.userEcosystems.find(n=>n.id===a);i&&this.switchEcosystem(i)})}),document.getElementById("eco-explore-btn")?.addEventListener("click",()=>this.showEcosystemExplore()),window.lucide&&window.lucide.createIcons())}switchEcosystem(e){this.activeEcosystem=e,this.applyEcosystemColors(e),this.renderEcosystemSwitcher(),this.updateAdminNavVisibility(),this.showGroups()}applyEcosystemColors(e){if(!e)return;let t=e.accent_color||"#10b981",s=e.secondary_color||"#6366f1",a=document.documentElement;a.style.setProperty("--eco-accent",t),a.style.setProperty("--eco-accent-rgb",this.hexToRgb(t)),a.style.setProperty("--eco-secondary",s),a.style.setProperty("--eco-secondary-rgb",this.hexToRgb(s))}hexToRgb(e){let t=e.replace("#","");if(t.length===3&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]),!/^[0-9a-fA-F]{6}$/.test(t))return"16, 185, 129";let s=parseInt(t.substring(0,2),16),a=parseInt(t.substring(2,4),16),i=parseInt(t.substring(4,6),16);return`${s}, ${a}, ${i}`}showCreateEcosystem(){let e=[{name:"Emerald",value:"#10b981"},{name:"Red",value:"#ef4444"},{name:"Blue",value:"#3b82f6"},{name:"Purple",value:"#8b5cf6"},{name:"Amber",value:"#f59e0b"},{name:"Cyan",value:"#06b6d4"},{name:"Pink",value:"#ec4899"}];this.setContent(`
      <div class="h-full w-full flex flex-col">
        <div class="panel flex-1">
          <div class="panel-header">
            <div class="flex items-center gap-3">
                ...
                <div class="flex gap-2 flex-wrap" id="color-picker">
                  ${e.map((a,i)=>`
                    <button type="button" class="color-swatch w-8 h-8 rounded-lg border-2 transition-all ${i===0?"border-white scale-110":"border-transparent hover:border-zinc-500"}" 
                            data-color="${a.value}" style="background-color: ${a.value}" title="${a.name}"></button>
                  `).join("")}
                </div>
    ...
    `),document.getElementById("eco-back-btn")?.addEventListener("click",()=>this.showExplore());let t=document.querySelector('#create-eco-form input[name="name"]'),s=document.querySelector('#create-eco-form input[name="slug"]');t&&s&&(t.addEventListener("input",()=>{s.dataset.manual||(s.value=t.value.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,""))}),s.addEventListener("input",()=>{s.dataset.manual="1"})),document.querySelectorAll(".color-swatch").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".color-swatch").forEach(n=>{n.classList.remove("border-white","scale-110"),n.classList.add("border-transparent")}),a.classList.add("border-white","scale-110"),a.classList.remove("border-transparent");let i=document.querySelector('#create-eco-form input[name="accent_color"]');i&&(i.value=a.dataset.color||"")})}),document.getElementById("eco-icon-preview")?.addEventListener("click",()=>{document.getElementById("eco-icon-input")?.click()}),document.getElementById("eco-icon-input")?.addEventListener("change",async a=>{let i=a.target.files?.[0];if(!i)return;let n=document.getElementById("eco-icon-preview"),l=document.getElementById("eco-icon-status");n&&(n.innerHTML='<div class="animate-pulse w-full h-full bg-zinc-700 rounded-xl"></div>');try{let o=new FormData;o.append("file",i);let r=await fetch("/api/upload/image",{method:"POST",headers:{"X-Auth-Hash":this.appState.hash||""},body:o});if(r.ok){let p=await r.json();document.getElementById("eco-icon-url").value=p.url,n&&(n.innerHTML=`<img src="${p.url}" class="w-full h-full object-cover">`,n.classList.remove("border-dashed","border-zinc-600"),n.classList.add("border-solid","border-emerald-500")),l&&(l.textContent="Icon uploaded",l.classList.remove("hidden"))}else n&&(n.innerHTML='<div class="text-center"><i data-lucide="image-plus" class="w-5 h-5 text-red-400 mx-auto"></i><p class="text-[9px] text-red-400 mt-0.5">Failed</p></div>',window.lucide&&window.lucide.createIcons()),C("Failed to upload icon","error")}catch{C("Failed to upload icon","error")}}),document.getElementById("create-eco-form")?.addEventListener("submit",async a=>{a.preventDefault();let i=a.target,n=new FormData(i),l=document.getElementById("eco-create-error");l.classList.add("hidden");try{let o=await fetch("/api/ecosystems",{method:"POST",headers:{"Content-Type":"application/json","X-Auth-Hash":this.appState.hash||""},body:JSON.stringify({name:n.get("name"),slug:n.get("slug"),description:n.get("description"),accent_color:n.get("accent_color"),icon:n.get("icon")||""})});if(o.ok){let r=await o.json();if(await this.loadUserEcosystems(),r.id){let p=this.userEcosystems.find(m=>m.id===r.id);p?this.switchEcosystem(p):this.showExplore()}else this.showExplore();C("Ecosystem created!","success")}else{let r=await o.json().catch(()=>({detail:"Failed to create ecosystem"}));l.textContent=r.detail||"Failed to create ecosystem",l.classList.remove("hidden")}}catch{l.textContent="Failed to create ecosystem",l.classList.remove("hidden")}})}escapeHtml(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}parseMarkdown(e){return me(e)}parseMarkdownPreview(e){let t=me(e),s=document.createElement("div");return s.innerHTML=t,s.textContent||s.innerText||e}isWithinEditWindow(e){return(Date.now()-new Date(e).getTime())/1e3<=180}isWithinDeleteWindow(e){return(Date.now()-new Date(e).getTime())/1e3<=60}getRemainingTime(e,t){let s=(Date.now()-new Date(e).getTime())/1e3,a=Math.max(0,t-s);if(a<=0)return"expired";let i=Math.floor(a/60),n=Math.floor(a%60);return i>0?`${i}m ${n}s left`:`${n}s left`}async editPost(e,t){let s=prompt("Edit your post:",t);if(!(s===null||s.trim()===t.trim()))try{let a=await fetch(`/api/posts/${e}`,{method:"PUT",headers:{"Content-Type":"application/json","X-Auth-Hash":this.appState.hash||""},body:JSON.stringify({content:s.trim()})});if(!a.ok){let i=await a.json();D(i.detail||"Failed to edit post","error");return}this.loadFeed()}catch(a){console.error("Edit error:",a),D("Failed to edit post","error")}}async deletePost(e){if(confirm("Delete this post? This cannot be undone."))try{let t=await fetch(`/api/posts/${e}`,{method:"DELETE",headers:{"X-Auth-Hash":this.appState.hash||""}});if(!t.ok){let a=await t.json();D(a.detail||"Failed to delete post","error");return}let s=document.querySelector(`[data-post-id="${e}"]`);s&&s.remove()}catch(t){console.error("Delete error:",t),D("Failed to delete post","error")}}async openEmojiDrawer(e,t,s,a){if(this.emojiDrawer.visible&&this.emojiDrawer.targetId===t&&this.emojiDrawer.targetType===e){this.closeEmojiDrawer();return}this.closeEmojiDrawer(),this.emojiDrawer.visible=!0,this.emojiDrawer.targetType=e,this.emojiDrawer.targetId=t,this.emojiDrawer.groupId=a,this.emojiDrawer.pack="twemoji",this.emojiDrawer.category="",this.emojiDrawer.search="",this.emojiDrawer.page=0,this.emojiDrawer.emoji=[],this.emojiDrawer.hasMore=!0;let i=document.createElement("div");i.id="emoji-drawer",i.style.cssText="position:absolute;z-index:9999;width:300px;background:#18181b;border:1px solid #3f3f46;border-radius:12px;box-shadow:0 8px 32px rgba(0,0,0,0.5);padding:8px;",this.emojiDrawer.element=i;let n=s.getBoundingClientRect();document.body.appendChild(i),window.innerHeight-n.bottom<250?i.style.top=n.top+window.scrollY-220+"px":i.style.top=n.bottom+window.scrollY+4+"px",i.style.left=Math.max(4,Math.min(n.left+window.scrollX-100,window.innerWidth-310))+"px",this.renderEmojiDrawer(),await this.loadEmoji(!0),this.emojiDrawerOutsideHandler=o=>{this.emojiDrawer.element&&!this.emojiDrawer.element.contains(o.target)&&o.target!==s&&this.closeEmojiDrawer()},setTimeout(()=>{this.emojiDrawerOutsideHandler&&document.addEventListener("click",this.emojiDrawerOutsideHandler)},10),this.emojiDrawerScrollHandler=()=>{this.closeEmojiDrawer()},window.addEventListener("scroll",this.emojiDrawerScrollHandler,!0)}emojiDrawerOutsideHandler=null;emojiDrawerScrollHandler=null;closeEmojiDrawer(){this.emojiDrawerOutsideHandler&&(document.removeEventListener("click",this.emojiDrawerOutsideHandler),this.emojiDrawerOutsideHandler=null),this.emojiDrawerScrollHandler&&(window.removeEventListener("scroll",this.emojiDrawerScrollHandler,!0),this.emojiDrawerScrollHandler=null),this.emojiDrawer.element&&(this.emojiDrawer.element.remove(),this.emojiDrawer.element=null),this.emojiDrawer.visible=!1,this.emojiDrawer.emoji=[]}async loadEmoji(e){if(!this.emojiDrawer.loading&&!(!e&&!this.emojiDrawer.hasMore)){this.emojiDrawer.loading=!0,e&&(this.emojiDrawer.page=0,this.emojiDrawer.emoji=[],this.emojiDrawer.hasMore=!0);try{let t=new URLSearchParams({pack:this.emojiDrawer.pack,page:String(this.emojiDrawer.page),per_page:"30"});this.emojiDrawer.category&&t.set("category",this.emojiDrawer.category),this.emojiDrawer.search&&t.set("search",this.emojiDrawer.search);let s=await fetch(`/api/emoji?${t.toString()}`);if(s.ok){let a=await s.json();this.emojiDrawer.emoji=e?a.emoji:[...this.emojiDrawer.emoji,...a.emoji],this.emojiDrawer.hasMore=a.has_more,this.emojiDrawer.page=a.page+1,this.renderEmojiDrawer()}}catch(t){console.error("Failed to load emoji:",t)}finally{this.emojiDrawer.loading=!1}}}renderEmojiDrawer(){let e=this.emojiDrawer.element;if(!e)return;let t=["twemoji","openmoji","noto"],s=["smileys","people","animals","food","travel","activities","objects","symbols","flags","hands","hearts","other"],a=t.map(r=>`<button class="ed-pack-tab" data-pack="${r}" style="padding:3px 8px;border-radius:6px;font-size:11px;font-weight:600;border:none;cursor:pointer;background:${this.emojiDrawer.pack===r?"#10b981":"#27272a"};color:${this.emojiDrawer.pack===r?"#fff":"#a1a1aa"};transition:all 0.15s;">${r.charAt(0).toUpperCase()+r.slice(1)}</button>`).join(""),i=`<button class="ed-cat-pill" data-cat="" style="padding:2px 6px;border-radius:8px;font-size:10px;border:none;cursor:pointer;white-space:nowrap;background:${this.emojiDrawer.category?"#27272a":"#10b981"};color:${this.emojiDrawer.category?"#a1a1aa":"#fff"};">All</button>`+s.map(r=>`<button class="ed-cat-pill" data-cat="${r}" style="padding:2px 6px;border-radius:8px;font-size:10px;border:none;cursor:pointer;white-space:nowrap;background:${this.emojiDrawer.category===r?"#10b981":"#27272a"};color:${this.emojiDrawer.category===r?"#fff":"#a1a1aa"};">${r}</button>`).join(""),n=this.emojiDrawer.emoji.map(r=>{let p=this.escapeHtml(r.c||""),m=this.escapeHtml(r.pack||this.emojiDrawer.pack),f=this.escapeHtml(r.f||""),b=this.escapeHtml(r.e||r.c||"");return`<button class="ed-emoji-btn" data-codepoint="${p}" data-pack="${m}" style="width:28px;height:28px;padding:0;border:none;background:transparent;cursor:pointer;border-radius:4px;display:flex;align-items:center;justify-content:center;flex-shrink:0;" title="${b}"><img src="/static/emoji/${m}/${f}" width="24" height="24" loading="lazy" style="pointer-events:none;"></button>`}).join("");e.innerHTML=`
      <div style="display:flex;gap:4px;margin-bottom:6px;">${a}</div>
      ...
      <div style="display:flex;gap:3px;overflow-x:auto;padding-bottom:4px;margin-bottom:6px;" class="custom-scrollbar">${i}</div>
    ...
    `,e.querySelectorAll(".ed-pack-tab").forEach(r=>{r.addEventListener("click",p=>{p.stopPropagation(),this.emojiDrawer.pack=p.currentTarget.dataset.pack||"twemoji",this.loadEmoji(!0)})}),e.querySelectorAll(".ed-cat-pill").forEach(r=>{r.addEventListener("click",p=>{p.stopPropagation(),this.emojiDrawer.category=p.currentTarget.dataset.cat||"",this.loadEmoji(!0)})});let l=e.querySelector(".ed-search");if(l){let r;l.addEventListener("input",p=>{p.stopPropagation(),clearTimeout(r),r=setTimeout(()=>{this.emojiDrawer.search=l.value,this.loadEmoji(!0)},300)}),l.addEventListener("click",p=>p.stopPropagation())}e.querySelectorAll(".ed-emoji-btn").forEach(r=>{r.addEventListener("click",p=>{p.stopPropagation();let m=p.currentTarget,f=m.dataset.codepoint||"",b=m.dataset.pack||this.emojiDrawer.pack;this.toggleReaction(this.emojiDrawer.targetType,this.emojiDrawer.targetId,b,f,this.emojiDrawer.groupId),this.closeEmojiDrawer()})});let o=e.querySelector(".ed-grid");o&&o.addEventListener("scroll",()=>{if(this.emojiDrawer.hasMore&&!this.emojiDrawer.loading){let r=o;r.scrollLeft+r.clientWidth>=r.scrollWidth-50&&this.loadEmoji()}})}async toggleReaction(e,t,s,a,i){try{let n;e==="post"?n=`/api/posts/${t}/reactions`:e==="dm"?n=`/api/dm/${i}/messages/${t}/reactions`:n=`/api/groups/${i}/messages/${t}/reactions`;let l=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json","X-Auth-Hash":this.appState.hash||""},body:JSON.stringify({emoji:a,pack:s})});if(l.ok){let o=await l.json();if(e==="post"){let r=document.querySelector(`.reactions-display[data-post-id="${t}"]`);r&&this.renderReactionBadges(r,o.reactions,"post",t)}else if(e==="dm"){let r=document.querySelector(`.dm-reactions-display[data-dm-msg-id="${t}"]`);r&&this.renderReactionBadges(r,o.reactions,"dm",t,i)}else{let r=document.querySelector(`.msg-reactions-display[data-msg-id="${t}"]`);r&&this.renderReactionBadges(r,o.reactions,"message",t,i)}}}catch(n){console.error("Failed to toggle reaction:",n)}}async loadReactions(e,t,s){try{let a;e==="post"?a=`/api/posts/${t}/reactions`:e==="dm"?a=`/api/dm/${s}/messages/${t}/reactions`:a=`/api/groups/${s}/messages/${t}/reactions`;let i=await fetch(a,{headers:{"X-Auth-Hash":this.appState.hash||""}});if(i.ok){let n=await i.json(),l;e==="post"?l=document.querySelector(`.reactions-display[data-post-id="${t}"]`):e==="dm"?l=document.querySelector(`.dm-reactions-display[data-dm-msg-id="${t}"]`):l=document.querySelector(`.msg-reactions-display[data-msg-id="${t}"]`),l&&this.renderReactionBadges(l,n.reactions,e,t,s)}}catch{}}renderReactionBadges(e,t,s,a,i){if(!t||typeof t!="object"){e.innerHTML="";return}let n=this.appState.user?.id||"",l=[];for(let[o,r]of Object.entries(t)){if(!r||!r.count||r.count<=0)continue;let p=r.users&&Array.isArray(r.users)&&r.users.includes(n),m=p?"rgba(16,185,129,0.1)":"rgba(63,63,70,0.3)",f=p?"#10b981":"#3f3f46",b=this.escapeHtml(r.pack||"twemoji"),u=this.escapeHtml(r.filename||r.f||""),h=this.escapeHtml(o),v=this.escapeHtml(a),y=i?this.escapeHtml(i):"",w=u?`/static/emoji/${b}/${u}`:"",k=r.user_names&&Array.isArray(r.user_names)?r.user_names.map(S=>this.escapeHtml(S)).join(", "):"";l.push(`<button class="rxn-badge" data-codepoint="${h}" data-pack="${b}" data-target-type="${s}" data-target-id="${v}" data-user-names="${this.escapeHtml(k)}" ${y?`data-group-id="${y}"`:""} style="display:inline-flex;align-items:center;gap:3px;padding:2px 8px;border-radius:999px;border:1px solid ${f};background:${m};cursor:pointer;font-size:11px;color:#d4d4d8;transition:all 0.15s;line-height:1;">${w?`<img src="${w}" width="16" height="16" style="pointer-events:none;">`:h} <span>${r.count}</span></button>`)}e.innerHTML=l.join(""),e.querySelectorAll(".rxn-badge").forEach(o=>{o.addEventListener("click",r=>{r.stopPropagation();let p=r.currentTarget,m=p.dataset.userNames||"";if(document.querySelectorAll(".rxn-tooltip").forEach(h=>h.remove()),!m)return;let f=document.createElement("div");f.className="rxn-tooltip",f.style.cssText="position:absolute;z-index:9999;background:#1c1c20;border:1px solid #3f3f46;border-radius:8px;padding:6px 10px;box-shadow:0 4px 16px rgba(0,0,0,0.5);font-size:12px;color:#d4d4d8;white-space:nowrap;max-width:200px;overflow:hidden;text-overflow:ellipsis;",f.textContent=m,document.body.appendChild(f);let b=p.getBoundingClientRect();f.style.top=b.top+window.scrollY-f.offsetHeight-6+"px",f.style.left=Math.max(4,Math.min(b.left+window.scrollX+b.width/2-f.offsetWidth/2,window.innerWidth-f.offsetWidth-4))+"px";let u=h=>{f.contains(h.target)||(f.remove(),document.removeEventListener("click",u))};setTimeout(()=>document.addEventListener("click",u),10)})})}attachDMReactionListeners(e){let t=document.getElementById("dm-messages");t&&(t.querySelectorAll(".dm-msg-wrapper").forEach(s=>{s._dmReactionBound||(s._dmReactionBound=!0,s.addEventListener("mouseenter",()=>{let a=s.querySelector(".dm-reaction-btn");a&&(a.style.display="flex")}),s.addEventListener("mouseleave",()=>{let a=s.querySelector(".dm-reaction-btn");a&&(a.style.display="none")}))}),t.querySelectorAll(".dm-reaction-btn").forEach(s=>{s._dmReactionClickBound||(s._dmReactionClickBound=!0,s.addEventListener("click",a=>{a.stopPropagation();let i=a.currentTarget,n=i.dataset.dmMsgId||"";n&&this.openEmojiDrawer("dm",n,i,e)}))}),t.querySelectorAll(".dm-reactions-display[data-dm-msg-id]").forEach(s=>{if(s._dmReactionLoadBound)return;s._dmReactionLoadBound=!0;let a=s.dataset.dmMsgId;a&&this.loadReactions("dm",a,e)}))}attachThreadBadgeListeners(){let e=document.getElementById("messages-container");e&&(e.__threadDelegationAttached||(e.__threadDelegationAttached=!0,e.addEventListener("click",t=>{let s=t.target.closest(".thread-badge-btn");if(s){t.stopPropagation();let a=s.dataset.threadRoot;a&&this.openThreadView(a)}})))}attachMsgReactionListeners(){let e=document.getElementById("messages-container");e&&(e.querySelectorAll(".chat-msg-wrapper").forEach(t=>{t.addEventListener("mouseenter",()=>{let s=t.querySelector(".msg-reaction-btn");s&&(s.style.display="flex")}),t.addEventListener("mouseleave",()=>{let s=t.querySelector(".msg-reaction-btn");s&&(s.style.display="none")})}),e.querySelectorAll(".msg-reaction-btn").forEach(t=>{t.addEventListener("click",s=>{s.stopPropagation();let a=s.currentTarget,i=a.dataset.msgId||"",n=a.dataset.groupId||this.currentGroup?.id||"";i&&this.openEmojiDrawer("message",i,a,n)})}),e.querySelectorAll(".msg-reactions-display[data-msg-id]").forEach(t=>{let s=t.dataset.msgId,a=this.currentGroup?.id;s&&a&&this.loadReactions("message",s,a)}))}};document.addEventListener("DOMContentLoaded",()=>{new Pt});})();
